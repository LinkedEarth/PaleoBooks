...
.. grid:: 1 2 3 3
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: C-iTrace Paleobook :bdg-danger:`C-iTRACE`  :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Lifehacks` :bdg-emerald:`Science Bits`, :bdg-success:`watermass geometry` :bdg-success:`model output` :bdg-success:`tracers` :bdg-success:`coordinate systems` :bdg-success:`clustering` :bdg-success:`C14` :bdg-success:`Paleoceanography` :bdg-success:`oceanography` :bdg-success:`data viz` :bdg-success:`machine learning` :bdg-success:`Mystery Interval` :bdg-success:`Deglaciation` :bdg-success:`eNd`, :bdg-primary:`matplotlib` :bdg-primary:`xarray` :bdg-primary:`scikit-learn` :bdg-primary:`intake` :bdg-primary:`seaborn` :bdg-primary:`pandas` :bdg-primary:`cartopy`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: LMR-CMIP6 Paleobook :bdg-danger:`LMR-CMIP6`  :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Lifehacks` :bdg-emerald:`Science Bits`, :bdg-success:`Holocene climate` :bdg-success:`LMR` :bdg-success:`model output` :bdg-success:`coordinate systems` :bdg-success:`CMIP6` :bdg-success:`AWS` :bdg-success:`Volcanic Input` :bdg-success:`data viz` :bdg-success:`cloud-ready data`, :bdg-primary:`matplotlib` :bdg-primary:`xarray` :bdg-primary:`intake` :bdg-primary:`ipywidgets` :bdg-primary:`pandas` :bdg-primary:`AWS` :bdg-primary:`cartopy` :bdg-primary:`pyleoclim`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: Reproducing the Hockey Stick - Proxy composite over the past 2,000 years using the cfr package :bdg-danger:`2k Proxy Composite`  :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Science Bits`, :bdg-success:`temperature` :bdg-success:`proxy composite`, :bdg-primary:`numpy` :bdg-primary:`cfr` :bdg-primary:`seaborn` :bdg-primary:`pandas` :bdg-primary:`pyleoclim`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: Watermass Geometry Proto exercise :bdg-danger:`PrototypeWMG`  :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Science Bits`, :bdg-success:`clustering` :bdg-success:`tracers` :bdg-success:`watermass geometry` :bdg-success:`endmember mixing`, :bdg-primary:`scipy` :bdg-primary:`matplotlib` :bdg-primary:`scikit-learn` :bdg-primary:`basemap` :bdg-primary:`sqlalchemy` :bdg-primary:`pandas`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: Detecting paleoclimate transitions with Laplacian Eigenmaps of Recurrence Matrices (LERM) :bdg-danger:`Detecting Paleoclimate Transitions with LERM` :bdg-warning:`published` :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Main Analysis` :bdg-emerald:`Extras`, :bdg-success:`data viz`, :bdg-primary:`ammonyte` :bdg-primary:`matplotlib` :bdg-primary:`pyleoclim`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: Reproducible workflows using the Pyleoclim package :bdg-danger:`Pyleoclim science` :bdg-warning:`published` :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Science Bits`, :bdg-success:`cross-wavelet analysis` :bdg-success:`paleoceanography` :bdg-success:`wavelet analysis` :bdg-success:`correlation` :bdg-success:`paleoclimate` :bdg-success:`model output` :bdg-success:`spectral analysis` :bdg-success:`insolation` :bdg-success:`model-data comparison` :bdg-success:`age uncertainty`, :bdg-primary:`xarray` :bdg-primary:`climlab` :bdg-primary:`pylipd` :bdg-primary:`cartopy` :bdg-primary:`pyleoclim`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: Coral Sr/Ca Calibration - An Example from Dry Tortugas :bdg-danger:`Coral Sr/Ca calibration`  :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Calibration` :bdg-emerald:`Getting Started`, :bdg-success:`paleoceanography` :bdg-success:`Bayesian Statistics` :bdg-success:`Statistics` :bdg-success:`coral` :bdg-success:`Sr/Ca` :bdg-success:`Calibration` :bdg-success:`calibration` :bdg-success:`Paleocenography`, :bdg-primary:`matplotlib` :bdg-primary:`pymc` :bdg-primary:`pandas` :bdg-primary:`arviz` :bdg-primary:`statsmodel` :bdg-primary:`Great Tables` :bdg-primary:`pyleoclim`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: PaleoPCA :bdg-danger:`PaleoPCA`  :bdg-teal:`python`
                                :link: https://projectpythia.org/paleoPCA-cookbook/
                                :img-top: https://raw.githubusercontent.com/khider/paleoPCA/main/thumbnails/LinkedEarth.png
                                :img-alt: LinkedEarth.png

                                :bdg-emerald:`Science Bits`, :bdg-success:`paleoceanography` :bdg-success:`modeling` :bdg-success:`PCA`, :bdg-primary:`matplotlib` :bdg-primary:`xarray` :bdg-primary:`eofs` :bdg-primary:`pandas` :bdg-primary:`cartopy` :bdg-primary:`pyleoclim`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: Comparing Paleoclimate Ensembles :bdg-danger:`PaleoEnsembles` :bdg-warning:`published` :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Plume Distance` :bdg-emerald:`Paleoclimate Applications` :bdg-emerald:`Motivation` :bdg-emerald:`Temporal Interpretation`, :bdg-success:`PMIP` :bdg-success:`statistics` :bdg-success:`paleoclimatology` :bdg-success:`PaMoDaCo` :bdg-success:`data assimilation` :bdg-success:`data viz` :bdg-success:`Common Era` :bdg-success:`timeseries modeling` :bdg-success:`reconstruction`, :bdg-primary:`scipy` :bdg-primary:`pens` :bdg-primary:`statsmodels` :bdg-primary:`matplotlib` :bdg-primary:`seaborn` :bdg-primary:`pandas` :bdg-primary:`pyleoclim`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: Regime Shifts in Holocene Paleohydrology as Recorded by Asian Speleothems :bdg-danger:`Asian Speleothem Coherency` :bdg-warning:`published` :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Main Analysis` :bdg-emerald:`Loading Data` :bdg-emerald:`Exploring the Data`, :bdg-success:`data wrangling` :bdg-success:`data viz` :bdg-success:`data analysis`, :bdg-primary:`matplotlib` :bdg-primary:`pyLiPD` :bdg-primary:`basemap` :bdg-primary:`ammonyte` :bdg-primary:`pylipd` :bdg-primary:`pyleoclim`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: geoChronR Vignettes (McKay et al., 2021) :bdg-danger:`geoChronR` :bdg-warning:`published` :bdg-mauve:`R`
                                ...
                                :bdg-emerald:`Extensions` :bdg-emerald:`Data Manipulation` :bdg-emerald:`Core Methods`, :bdg-success:`PCA` :bdg-success:`age modeling` :bdg-success:`dimension reduction` :bdg-success:`visualization` :bdg-success:`tidyverse` :bdg-success:`ensemble` :bdg-success:`calibration` :bdg-success:`correlation` :bdg-success:`data wrangling` :bdg-success:`mapping` :bdg-success:`regression` :bdg-success:`spectral analysis` :bdg-success:`wavelets` :bdg-success:`uncertainty quantification` :bdg-success:`age uncertainty` :bdg-success:`LiPD`, :bdg-primary:`lipdR` :bdg-primary:`purrr` :bdg-primary:`ggplot2` :bdg-primary:`oxcAAR` :bdg-primary:`readr` :bdg-primary:`dplyr`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: Global Speleothem Analysis Reveals State-Dependent Hydrological Response to Orbital Forcing :bdg-danger:`Global Speleothem Analysis` :bdg-warning:`published` :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Exploring the Data` :bdg-emerald:`Global Coherence Analysis` :bdg-emerald:`Heuristic Examples` :bdg-emerald:`Correlation Analysis`, :bdg-success:`statistics` :bdg-success:`signal processing` :bdg-success:`data analysis` :bdg-success:`paleoclimate` :bdg-success:`data wrangling` :bdg-success:`geospatial` :bdg-success:`data viz`, :bdg-primary:`matplotlib` :bdg-primary:`numpy` :bdg-primary:`climlab` :bdg-primary:`pylipd` :bdg-primary:`cartopy` :bdg-primary:`pyleoclim`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: Constraining Equilibrium Climate Sensitivity using the Last Millennium GMST :bdg-danger:`ECS (Cropper et al, 2023)` :bdg-warning:`published` :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Main Analysis` :bdg-emerald:`Supplement` :bdg-emerald:`EC Calculations`, :bdg-success:`data viz` :bdg-success:`data supplement` :bdg-success:`climate sensitivity`, :bdg-primary:`scipy` :bdg-primary:`statsmodels` :bdg-primary:`matplotlib` :bdg-primary:`pyleoclim`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: Reproducing LMRv2.1 with PAGES 2k records and LinkedEarth tools :bdg-danger:`Assimilating PAGES2k with CFR`  :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Data Assembly` :bdg-emerald:`Data Assimilation` :bdg-emerald:`Validation and Comparison`, :bdg-success:`data wrangling` :bdg-success:`data assimilation` :bdg-success:`data viz` :bdg-success:`data analysis`, :bdg-primary:`pens` :bdg-primary:`matplotlib` :bdg-primary:`xarray` :bdg-primary:`cfr`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: Updating LMRv2.1 with PReSto2k data and LinkedEarth Tools :bdg-danger:`Assimilating PReSto2k with CFR`  :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Data Assembly` :bdg-emerald:`Data Assimilation` :bdg-emerald:`Validation and Comparison`, :bdg-success:`data wrangling` :bdg-success:`data assimilation` :bdg-success:`data viz` :bdg-success:`data analysis`, :bdg-primary:`pens` :bdg-primary:`matplotlib` :bdg-primary:`cfr` :bdg-primary:`pylipd` :bdg-primary:`cartopy`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            :tags: common-era-solar-signature deep-dive-into-dome-c fun-in-the-frequency-domain millennial--to-orbital-scale-variability-and-insolation sparql cartopy cross-wavelet-analysis insolation knowledge-base matplotlib paleoclimate pandas pangaeapy pyleoclim pylipd python scaling-behavior seaborn singular-spectrum-analysis spectral-analysis spectral-peaks wavelet-analysis
                            :outline: teal

                            .. card:: Fun in The Frequency Domain :bdg-danger:`Fun in The Frequency Domain`  :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Deep Dive into Dome C` :bdg-emerald:`Millennial- to orbital-scale variability and Insolation` :bdg-emerald:`Common Era Solar Signature`, :bdg-success:`cross-wavelet analysis` :bdg-success:`wavelet analysis` :bdg-success:`spectral peaks` :bdg-success:`knowledge base` :bdg-success:`paleoclimate` :bdg-success:`scaling behavior` :bdg-success:`SPARQL` :bdg-success:`spectral analysis` :bdg-success:`singular spectrum analysis` :bdg-success:`insolation`, :bdg-primary:`matplotlib` :bdg-primary:`seaborn` :bdg-primary:`pandas` :bdg-primary:`pylipd` :bdg-primary:`pangaeapy` :bdg-primary:`cartopy` :bdg-primary:`pyleoclim`
...
.. grid:: 1 2 3 3
                        ...
                        .. grid-item::
                            ...
                            .. tagged-card:: 
                                :tags: common-era-solar-signature fun-in-the-frequency-domain cross-wavelet-analysis insolation notebook paleoclimate pyleoclim python
                                :outline: teal

                                .. card:: Solar-Climate Connections :bdg-danger:`Fun in The Frequency Domain` :bdg-teal:`python`
                        ...
                        .. grid-item::
                            ...
                            .. tagged-card:: 
                                :tags: fun-in-the-frequency-domain millennial--to-orbital-scale-variability-and-insolation sparql knowledge-base notebook pandas python
                                :outline: teal

                                .. card:: Query LiPDGraph :bdg-danger:`Fun in The Frequency Domain` :bdg-teal:`python`
                        ...
                        .. grid-item::
                            ...
                            .. tagged-card:: 
                                :tags: fun-in-the-frequency-domain millennial--to-orbital-scale-variability-and-insolation cartopy matplotlib notebook paleoclimate pyleoclim pylipd python scaling-behavior seaborn spectral-analysis
                                :outline: teal

                                .. card:: Holocene Scaling Behavior :bdg-danger:`Fun in The Frequency Domain` :bdg-teal:`python`
                        ...
                        .. grid-item::
                            ...
                            .. tagged-card:: 
                                :tags: fun-in-the-frequency-domain millennial--to-orbital-scale-variability-and-insolation cartopy matplotlib notebook paleoclimate pyleoclim python seaborn spectral-analysis spectral-peaks
                                :outline: teal

                                .. card:: Holocene Spectral Peaks :bdg-danger:`Fun in The Frequency Domain` :bdg-teal:`python`
                        ...
                        .. grid-item::
                            ...
                            .. tagged-card:: 
                                :tags: deep-dive-into-dome-c fun-in-the-frequency-domain cross-wavelet-analysis notebook paleoclimate pyleoclim python singular-spectrum-analysis spectral-analysis wavelet-analysis
                                :outline: teal

                                .. card:: EPICAC :bdg-danger:`Fun in The Frequency Domain` :bdg-teal:`python`
                                    ...
                                    :bdg-emerald:`paleoclimate` :bdg-emerald:`spectral analysis` :bdg-emerald:`wavelet analysis` :bdg-emerald:`cross-wavelet analysis` :bdg-emerald:`singular spectrum analysis`, :bdg-success:`pyleoclim`, :bdg-primary:`Deep Dive into Dome C`
                        ...
                        .. grid-item::
                            ...
                            .. tagged-card:: 
                                :tags: deep-dive-into-dome-c fun-in-the-frequency-domain cross-wavelet-analysis notebook paleoclimate pangaeapy pyleoclim python spectral-analysis
                                :outline: teal

                                .. card:: U1385 :bdg-danger:`Fun in The Frequency Domain` :bdg-teal:`python`
                                    ...
                                    :bdg-emerald:`paleoclimate` :bdg-emerald:`spectral analysis` :bdg-emerald:`cross-wavelet analysis`, :bdg-success:`pyleoclim` :bdg-success:`pangaeapy`, :bdg-primary:`Deep Dive into Dome C`
