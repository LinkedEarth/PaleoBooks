                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: C-iTrace Paleobook :bdg-danger:`C-iTRACE` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`coordinate systems` :bdg-emerald:`clustering` :bdg-emerald:`Paleoceanography` :bdg-emerald:`tracers` :bdg-emerald:`oceanography` :bdg-emerald:`Deglaciation` :bdg-emerald:`Mystery Interval` :bdg-emerald:`machine learning` :bdg-emerald:`data viz` :bdg-emerald:`watermass geometry` :bdg-emerald:`eNd` :bdg-emerald:`C14` :bdg-emerald:`model output`, :bdg-success:`pandas` :bdg-success:`intake` :bdg-success:`scikit-learn` :bdg-success:`seaborn` :bdg-success:`xarray` :bdg-success:`matplotlib` :bdg-success:`cartopy`, :bdg-primary:`Lifehacks` :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: LMR-CMIP6 Paleobook :bdg-danger:`LMR-CMIP6` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`CMIP6` :bdg-emerald:`coordinate systems` :bdg-emerald:`AWS` :bdg-emerald:`LMR` :bdg-emerald:`cloud-ready data` :bdg-emerald:`Holocene climate` :bdg-emerald:`data viz` :bdg-emerald:`Volcanic Input` :bdg-emerald:`model output`, :bdg-success:`ipywidgets` :bdg-success:`AWS` :bdg-success:`pandas` :bdg-success:`intake` :bdg-success:`xarray` :bdg-success:`pyleoclim` :bdg-success:`matplotlib` :bdg-success:`cartopy`, :bdg-primary:`Lifehacks` :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducing the Hockey Stick - Proxy composite over the past 2,000 years using the cfr package :bdg-danger:`2k Proxy Composite` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`temperature` :bdg-emerald:`proxy composite`, :bdg-success:`cfr` :bdg-success:`numpy` :bdg-success:`pandas` :bdg-success:`seaborn` :bdg-success:`pyleoclim`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Watermass Geometry Proto exercise :bdg-danger:`PrototypeWMG` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`clustering` :bdg-emerald:`watermass geometry` :bdg-emerald:`endmember mixing` :bdg-emerald:`tracers`, :bdg-success:`basemap` :bdg-success:`sqlalchemy` :bdg-success:`scipy` :bdg-success:`pandas` :bdg-success:`scikit-learn` :bdg-success:`matplotlib`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducible workflows using the Pyleoclim package :bdg-danger:`Pyleoclim science` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`wavelet analysis` :bdg-emerald:`model-data comparison` :bdg-emerald:`paleoceanography` :bdg-emerald:`insolation` :bdg-emerald:`spectral analysis` :bdg-emerald:`correlation` :bdg-emerald:`cross-wavelet analysis` :bdg-emerald:`paleoclimate` :bdg-emerald:`age uncertainty` :bdg-emerald:`model output`, :bdg-success:`pylipd` :bdg-success:`climlab` :bdg-success:`xarray` :bdg-success:`pyleoclim` :bdg-success:`cartopy`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Coral Sr/Ca Calibration - An Example from Dry Tortugas :bdg-danger:`Coral Sr/Ca calibration` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`Bayesian Statistics` :bdg-emerald:`Sr/Ca` :bdg-emerald:`Calibration` :bdg-emerald:`paleoceanography` :bdg-emerald:`coral` :bdg-emerald:`Statistics` :bdg-emerald:`Paleocenography` :bdg-emerald:`calibration`, :bdg-success:`Great Tables` :bdg-success:`arviz` :bdg-success:`pymc` :bdg-success:`statsmodel` :bdg-success:`pandas` :bdg-success:`pyleoclim` :bdg-success:`matplotlib`, :bdg-primary:`Getting Started` :bdg-primary:`Calibration`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Investigating interhemispheric precipitation changes over the past millennium :bdg-danger:`PaleoPCA` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`paleoceanography` :bdg-emerald:`modeling` :bdg-emerald:`PCA`, :bdg-success:`eofs` :bdg-success:`pandas` :bdg-success:`xarray` :bdg-success:`pyleoclim` :bdg-success:`matplotlib` :bdg-success:`cartopy`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Comparing Paleoclimate Ensembles :bdg-danger:`PaleoEnsembles` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`reconstruction` :bdg-emerald:`PMIP` :bdg-emerald:`PaMoDaCo` :bdg-emerald:`data assimilation` :bdg-emerald:`timeseries modeling` :bdg-emerald:`paleoclimatology` :bdg-emerald:`Common Era` :bdg-emerald:`data viz` :bdg-emerald:`statistics`, :bdg-success:`pens` :bdg-success:`statsmodels` :bdg-success:`scipy` :bdg-success:`pandas` :bdg-success:`seaborn` :bdg-success:`pyleoclim` :bdg-success:`matplotlib`, :bdg-primary:`Plume Distance` :bdg-primary:`Paleoclimate Applications` :bdg-primary:`Motivation` :bdg-primary:`Temporal Interpretation`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Regime Shifts in Holocene Paleohydrology as Recorded by Asian Speleothems :bdg-danger:`Asian Speleothem Coherency` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data analysis` :bdg-emerald:`data viz` :bdg-emerald:`data wrangling`, :bdg-success:`basemap` :bdg-success:`ammonyte` :bdg-success:`pyLiPD` :bdg-success:`pylipd` :bdg-success:`pyleoclim` :bdg-success:`matplotlib`, :bdg-primary:`Main Analysis` :bdg-primary:`Exploring the Data` :bdg-primary:`Loading Data`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: geoChronR Vignettes (McKay et al., 2021) :bdg-danger:`geoChronR` :bdg-mauve:`R`
                            ...
                            :bdg-emerald:`LiPD` :bdg-emerald:`ensemble` :bdg-emerald:`wavelets` :bdg-emerald:`visualization` :bdg-emerald:`correlation` :bdg-emerald:`spectral analysis` :bdg-emerald:`age modeling` :bdg-emerald:`uncertainty quantification` :bdg-emerald:`regression` :bdg-emerald:`PCA` :bdg-emerald:`mapping` :bdg-emerald:`age uncertainty` :bdg-emerald:`dimension reduction` :bdg-emerald:`tidyverse` :bdg-emerald:`calibration` :bdg-emerald:`data wrangling`, :bdg-success:`lipdR` :bdg-success:`ggplot2` :bdg-success:`purrr` :bdg-success:`oxcAAR` :bdg-success:`readr` :bdg-success:`dplyr`, :bdg-primary:`Data Manipulation` :bdg-primary:`Core Methods` :bdg-primary:`Extensions`
