                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: C-iTrace Paleobook :bdg-danger:`C-iTRACE`  :bdg-teal:`python`
                            ...
                            :bdg-emerald:`coordinate systems` :bdg-emerald:`clustering` :bdg-emerald:`eNd` :bdg-emerald:`watermass geometry` :bdg-emerald:`oceanography` :bdg-emerald:`Deglaciation` :bdg-emerald:`model output` :bdg-emerald:`C14` :bdg-emerald:`Paleoceanography` :bdg-emerald:`Mystery Interval` :bdg-emerald:`machine learning` :bdg-emerald:`data viz` :bdg-emerald:`tracers`, :bdg-success:`intake` :bdg-success:`seaborn` :bdg-success:`matplotlib` :bdg-success:`scikit-learn` :bdg-success:`xarray` :bdg-success:`cartopy` :bdg-success:`pandas`, :bdg-primary:`Science Bits` :bdg-primary:`Lifehacks`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: LMR-CMIP6 Paleobook :bdg-danger:`LMR-CMIP6`  :bdg-teal:`python`
                            ...
                            :bdg-emerald:`AWS` :bdg-emerald:`coordinate systems` :bdg-emerald:`Holocene climate` :bdg-emerald:`Volcanic Input` :bdg-emerald:`LMR` :bdg-emerald:`CMIP6` :bdg-emerald:`cloud-ready data` :bdg-emerald:`model output` :bdg-emerald:`data viz`, :bdg-success:`ipywidgets` :bdg-success:`intake` :bdg-success:`AWS` :bdg-success:`matplotlib` :bdg-success:`xarray` :bdg-success:`cartopy` :bdg-success:`pandas` :bdg-success:`pyleoclim`, :bdg-primary:`Science Bits` :bdg-primary:`Lifehacks`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducing the Hockey Stick - Proxy composite over the past 2,000 years using the cfr package :bdg-danger:`2k Proxy Composite`  :bdg-teal:`python`
                            ...
                            :bdg-emerald:`temperature` :bdg-emerald:`proxy composite`, :bdg-success:`cfr` :bdg-success:`seaborn` :bdg-success:`numpy` :bdg-success:`pandas` :bdg-success:`pyleoclim`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Watermass Geometry Proto exercise :bdg-danger:`PrototypeWMG`  :bdg-teal:`python`
                            ...
                            :bdg-emerald:`clustering` :bdg-emerald:`endmember mixing` :bdg-emerald:`watermass geometry` :bdg-emerald:`tracers`, :bdg-success:`scipy` :bdg-success:`sqlalchemy` :bdg-success:`matplotlib` :bdg-success:`basemap` :bdg-success:`scikit-learn` :bdg-success:`pandas`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Detecting paleoclimate transitions with Laplacian Eigenmaps of Recurrence Matrices (LERM) :bdg-danger:`Detecting Paleoclimate Transitions with LERM`  :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data viz`, :bdg-success:`ammonyte` :bdg-success:`pyleoclim` :bdg-success:`matplotlib`, :bdg-primary:`Extras` :bdg-primary:`Main Analysis`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducible workflows using the Pyleoclim package :bdg-danger:`Pyleoclim science`  :bdg-teal:`python`
                            ...
                            :bdg-emerald:`paleoclimate` :bdg-emerald:`spectral analysis` :bdg-emerald:`model-data comparison` :bdg-emerald:`cross-wavelet analysis` :bdg-emerald:`correlation` :bdg-emerald:`insolation` :bdg-emerald:`wavelet analysis` :bdg-emerald:`age uncertainty` :bdg-emerald:`model output` :bdg-emerald:`paleoceanography`, :bdg-success:`xarray` :bdg-success:`cartopy` :bdg-success:`pylipd` :bdg-success:`climlab` :bdg-success:`pyleoclim`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Coral Sr/Ca Calibration - An Example from Dry Tortugas :bdg-danger:`Coral Sr/Ca calibration`  :bdg-teal:`python`
                            ...
                            :bdg-emerald:`Bayesian Statistics` :bdg-emerald:`calibration` :bdg-emerald:`Statistics` :bdg-emerald:`Calibration` :bdg-emerald:`Paleocenography` :bdg-emerald:`coral` :bdg-emerald:`Sr/Ca` :bdg-emerald:`paleoceanography`, :bdg-success:`matplotlib` :bdg-success:`pandas` :bdg-success:`statsmodel` :bdg-success:`Great Tables` :bdg-success:`pyleoclim` :bdg-success:`arviz` :bdg-success:`pymc`, :bdg-primary:`Getting Started` :bdg-primary:`Calibration`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Investigating interhemispheric precipitation changes over the past millennium :bdg-danger:`PaleoPCA`  :bdg-teal:`python`
                            ...
                            :bdg-emerald:`PCA` :bdg-emerald:`modeling` :bdg-emerald:`paleoceanography`, :bdg-success:`eofs` :bdg-success:`matplotlib` :bdg-success:`xarray` :bdg-success:`cartopy` :bdg-success:`pandas` :bdg-success:`pyleoclim`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Comparing Paleoclimate Ensembles :bdg-danger:`PaleoEnsembles`  :bdg-teal:`python`
                            ...
                            :bdg-emerald:`statistics` :bdg-emerald:`Common Era` :bdg-emerald:`data assimilation` :bdg-emerald:`paleoclimatology` :bdg-emerald:`PaMoDaCo` :bdg-emerald:`timeseries modeling` :bdg-emerald:`reconstruction` :bdg-emerald:`data viz` :bdg-emerald:`PMIP`, :bdg-success:`statsmodels` :bdg-success:`seaborn` :bdg-success:`scipy` :bdg-success:`matplotlib` :bdg-success:`pens` :bdg-success:`pandas` :bdg-success:`pyleoclim`, :bdg-primary:`Plume Distance` :bdg-primary:`Temporal Interpretation` :bdg-primary:`Motivation` :bdg-primary:`Paleoclimate Applications`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Regime Shifts in Holocene Paleohydrology as Recorded by Asian Speleothems :bdg-danger:`Asian Speleothem Coherency`  :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data analysis` :bdg-emerald:`data viz` :bdg-emerald:`data wrangling`, :bdg-success:`ammonyte` :bdg-success:`pyLiPD` :bdg-success:`basemap` :bdg-success:`matplotlib` :bdg-success:`pylipd` :bdg-success:`pyleoclim`, :bdg-primary:`Exploring the Data` :bdg-primary:`Loading Data` :bdg-primary:`Main Analysis`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: geoChronR Vignettes (McKay et al., 2021) :bdg-danger:`geoChronR`  :bdg-mauve:`R`
                            ...
                            :bdg-emerald:`spectral analysis` :bdg-emerald:`regression` :bdg-emerald:`correlation` :bdg-emerald:`uncertainty quantification` :bdg-emerald:`calibration` :bdg-emerald:`dimension reduction` :bdg-emerald:`PCA` :bdg-emerald:`tidyverse` :bdg-emerald:`LiPD` :bdg-emerald:`age uncertainty` :bdg-emerald:`age modeling` :bdg-emerald:`visualization` :bdg-emerald:`ensemble` :bdg-emerald:`wavelets` :bdg-emerald:`mapping` :bdg-emerald:`data wrangling`, :bdg-success:`ggplot2` :bdg-success:`oxcAAR` :bdg-success:`purrr` :bdg-success:`dplyr` :bdg-success:`readr` :bdg-success:`lipdR`, :bdg-primary:`Extensions` :bdg-primary:`Data Manipulation` :bdg-primary:`Core Methods`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Global Speleothem Analysis Reveals State-Dependent Hydrological Response to Orbital Forcing :bdg-danger:`Global Speleothem Analysis`  :bdg-teal:`python`
                            ...
                            :bdg-emerald:`paleoclimate` :bdg-emerald:`statistics` :bdg-emerald:`signal processing` :bdg-emerald:`geospatial` :bdg-emerald:`data analysis` :bdg-emerald:`data viz` :bdg-emerald:`data wrangling`, :bdg-success:`matplotlib` :bdg-success:`cartopy` :bdg-success:`numpy` :bdg-success:`pylipd` :bdg-success:`climlab` :bdg-success:`pyleoclim`, :bdg-primary:`Exploring the Data` :bdg-primary:`Global Coherence Analysis` :bdg-primary:`Heuristic Examples` :bdg-primary:`Correlation Analysis`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Constraining Equilibrium Climate Sensitivity using the Last Millennium GMST :bdg-danger:`ECS (Cropper et al, 2023)`  :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data supplement` :bdg-emerald:`climate sensitivity` :bdg-emerald:`data viz`, :bdg-success:`statsmodels` :bdg-success:`scipy` :bdg-success:`pyleoclim` :bdg-success:`matplotlib`, :bdg-primary:`Main Analysis` :bdg-primary:`Supplement` :bdg-primary:`EC Calculations`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducing LMRv2.1 with PAGES 2k records and LinkedEarth tools :bdg-danger:`Assimilating PAGES2k with CFR`  :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data analysis` :bdg-emerald:`data assimilation` :bdg-emerald:`data viz` :bdg-emerald:`data wrangling`, :bdg-success:`pens` :bdg-success:`xarray` :bdg-success:`matplotlib` :bdg-success:`cfr`, :bdg-primary:`Data Assembly` :bdg-primary:`Validation and Comparison` :bdg-primary:`Data Assimilation`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Updating LMRv2.1 with PReSto2k data and LinkedEarth Tools :bdg-danger:`Assimilating PReSto2k with CFR`  :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data analysis` :bdg-emerald:`data assimilation` :bdg-emerald:`data viz` :bdg-emerald:`data wrangling`, :bdg-success:`cfr` :bdg-success:`matplotlib` :bdg-success:`pens` :bdg-success:`cartopy` :bdg-success:`pylipd`, :bdg-primary:`Data Assembly` :bdg-primary:`Validation and Comparison` :bdg-primary:`Data Assimilation`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Fun in Frequency Domain :bdg-danger:`Fun in Frequency Domain`  :bdg-teal:`python`
                            ...
                            :bdg-emerald:`paleoclimate` :bdg-emerald:`spectral analysis` :bdg-emerald:`knowledge base` :bdg-emerald:`cross-wavelet analysis` :bdg-emerald:`insolation` :bdg-emerald:`wavelet analysis` :bdg-emerald:`scaling behavior` :bdg-emerald:`singular spectrum analysis` :bdg-emerald:`spectral peaks` :bdg-emerald:`SPARQL`, :bdg-success:`seaborn` :bdg-success:`pangaeapy` :bdg-success:`matplotlib` :bdg-success:`cartopy` :bdg-success:`pandas` :bdg-success:`pylipd` :bdg-success:`pyleoclim`, :bdg-primary:`Millennial- to orbital-scale variability and Insolation` :bdg-primary:`Deep Diving` :bdg-primary:`Common Era Solar Signature`
