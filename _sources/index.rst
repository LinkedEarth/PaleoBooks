                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: C-iTrace Paleobook :bdg-danger:`C-iTRACE`
                            ...
                            :bdg-primary:`clustering` :bdg-primary:`oceanography` :bdg-primary:`model output` :bdg-primary:`eNd` :bdg-primary:`data viz` :bdg-primary:`tracers` :bdg-primary:`watermass geometry` :bdg-primary:`Deglaciation` :bdg-primary:`machine learning` :bdg-primary:`Paleoceanography` :bdg-primary:`Mystery Interval` :bdg-primary:`C14` :bdg-primary:`coordinate systems`, :bdg-secondary:`intake` :bdg-secondary:`seaborn` :bdg-secondary:`cartopy` :bdg-secondary:`pandas` :bdg-secondary:`scikit-learn` :bdg-secondary:`xarray` :bdg-secondary:`matplotlib`, :bdg-success:`Lifehacks` :bdg-success:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: LMR-CMIP6 Paleobook :bdg-danger:`LMR-CMIP6`
                            ...
                            :bdg-primary:`CMIP6` :bdg-primary:`model output` :bdg-primary:`Holocene climate` :bdg-primary:`data viz` :bdg-primary:`LMR` :bdg-primary:`Volcanic Input` :bdg-primary:`cloud-ready data` :bdg-primary:`AWS` :bdg-primary:`coordinate systems`, :bdg-secondary:`intake` :bdg-secondary:`cartopy` :bdg-secondary:`ipywidgets` :bdg-secondary:`pandas` :bdg-secondary:`AWS` :bdg-secondary:`xarray` :bdg-secondary:`pyleoclim` :bdg-secondary:`matplotlib`, :bdg-success:`Lifehacks` :bdg-success:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducing the Hockey Stick - Proxy composite over the past 2,000 years using the cfr package :bdg-danger:`2k Proxy Composite`
                            ...
                            :bdg-primary:`temperature` :bdg-primary:`proxy composite`, :bdg-secondary:`seaborn` :bdg-secondary:`cfr` :bdg-secondary:`pandas` :bdg-secondary:`pyleoclim` :bdg-secondary:`numpy`, :bdg-success:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Watermass Geometry Proto exercise :bdg-danger:`PrototypeWMG`
                            ...
                            :bdg-primary:`clustering` :bdg-primary:`tracers` :bdg-primary:`watermass geometry` :bdg-primary:`endmember mixing`, :bdg-secondary:`pandas` :bdg-secondary:`scikit-learn` :bdg-secondary:`scipy` :bdg-secondary:`sqlalchemy` :bdg-secondary:`basemap` :bdg-secondary:`matplotlib`, :bdg-success:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Detecting paleoclimate transitions with Laplacian Eigenmaps of Recurrence Matrices (LERM) :bdg-danger:`Detecting Paleoclimate Transitions with LERM`
                            ...
                            :bdg-primary:`data viz`, :bdg-secondary:`pyleoclim` :bdg-secondary:`matplotlib` :bdg-secondary:`ammonyte`, :bdg-success:`Main Analysis` :bdg-success:`Extras`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducible workflows using the Pyleoclim package :bdg-danger:`Pyleoclim science`
                            ...
                            :bdg-primary:`model output` :bdg-primary:`spectral analysis` :bdg-primary:`model-data comparison` :bdg-primary:`paleoclimate` :bdg-primary:`correlation` :bdg-primary:`age uncertainty` :bdg-primary:`cross-wavelet analysis` :bdg-primary:`wavelet analysis` :bdg-primary:`paleoceanography` :bdg-primary:`insolation`, :bdg-secondary:`climlab` :bdg-secondary:`cartopy` :bdg-secondary:`xarray` :bdg-secondary:`pyleoclim` :bdg-secondary:`pylipd`, :bdg-success:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Coral Sr/Ca Calibration - An Example from Dry Tortugas :bdg-danger:`Coral Sr/Ca calibration`
                            ...
                            :bdg-primary:`Calibration` :bdg-primary:`Statistics` :bdg-primary:`Sr/Ca` :bdg-primary:`Paleocenography` :bdg-primary:`calibration` :bdg-primary:`Bayesian Statistics` :bdg-primary:`paleoceanography` :bdg-primary:`coral`, :bdg-secondary:`Great Tables` :bdg-secondary:`statsmodel` :bdg-secondary:`pandas` :bdg-secondary:`arviz` :bdg-secondary:`pymc` :bdg-secondary:`pyleoclim` :bdg-secondary:`matplotlib`, :bdg-success:`Calibration` :bdg-success:`Getting Started`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Investigating interhemispheric precipitation changes over the past millennium :bdg-danger:`PaleoPCA`
                            ...
                            :bdg-primary:`paleoceanography` :bdg-primary:`modeling` :bdg-primary:`PCA`, :bdg-secondary:`cartopy` :bdg-secondary:`pandas` :bdg-secondary:`eofs` :bdg-secondary:`xarray` :bdg-secondary:`pyleoclim` :bdg-secondary:`matplotlib`, :bdg-success:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Comparing Paleoclimate Ensembles :bdg-danger:`PaleoEnsembles`
                            ...
                            :bdg-primary:`data viz` :bdg-primary:`Common Era` :bdg-primary:`PMIP` :bdg-primary:`paleoclimatology` :bdg-primary:`statistics` :bdg-primary:`data assimilation` :bdg-primary:`timeseries modeling` :bdg-primary:`PaMoDaCo` :bdg-primary:`reconstruction`, :bdg-secondary:`statsmodels` :bdg-secondary:`seaborn` :bdg-secondary:`pandas` :bdg-secondary:`scipy` :bdg-secondary:`pens` :bdg-secondary:`pyleoclim` :bdg-secondary:`matplotlib`, :bdg-success:`Plume Distance` :bdg-success:`Temporal Interpretation` :bdg-success:`Paleoclimate Applications` :bdg-success:`Motivation`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Regime Shifts in Holocene Paleohydrology as Recorded by Asian Speleothems :bdg-danger:`Asian Speleothem Coherency`
                            ...
                            :bdg-primary:`data analysis` :bdg-primary:`data viz` :bdg-primary:`data wrangling`, :bdg-secondary:`ammonyte` :bdg-secondary:`basemap` :bdg-secondary:`pyLiPD` :bdg-secondary:`pyleoclim` :bdg-secondary:`matplotlib` :bdg-secondary:`pylipd`, :bdg-success:`Loading Data` :bdg-success:`Main Analysis` :bdg-success:`Exploring the Data`
