...
.. raw:: html
    ...
    Domains</button>
    <ul class="dropdown-menu" aria-labelledby="domainsDropdown"><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=aws onchange="change();">&nbsp;AWS</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=c14 onchange="change();">&nbsp;C14</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=cmip6 onchange="change();">&nbsp;CMIP6</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=deglaciation onchange="change();">&nbsp;Deglaciation</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=holocene-climate onchange="change();">&nbsp;Holocene climate</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=lmr onchange="change();">&nbsp;LMR</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=mystery-interval onchange="change();">&nbsp;Mystery Interval</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=paleoceanography onchange="change();">&nbsp;Paleoceanography</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=volcanic-input onchange="change();">&nbsp;Volcanic Input</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=age-uncertainty onchange="change();">&nbsp;age uncertainty</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=cloud-ready-data onchange="change();">&nbsp;cloud-ready data</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=clustering onchange="change();">&nbsp;clustering</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=coordinate-systems onchange="change();">&nbsp;coordinate systems</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=correlation onchange="change();">&nbsp;correlation</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=cross-wavelet-analysis onchange="change();">&nbsp;cross-wavelet analysis</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=data-viz onchange="change();">&nbsp;data viz</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=end onchange="change();">&nbsp;eNd</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=endmember-mixing onchange="change();">&nbsp;endmember mixing</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=insolation onchange="change();">&nbsp;insolation</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=machine-learning onchange="change();">&nbsp;machine learning</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=model-output onchange="change();">&nbsp;model output</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=model-data-comparison onchange="change();">&nbsp;model-data comparison</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=oceanography onchange="change();">&nbsp;oceanography</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=paleoceanography onchange="change();">&nbsp;paleoceanography</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=paleoclimate onchange="change();">&nbsp;paleoclimate</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=proxy-composite onchange="change();">&nbsp;proxy composite</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=spectral-analysis onchange="change();">&nbsp;spectral analysis</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=temperature onchange="change();">&nbsp;temperature</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=tracers onchange="change();">&nbsp;tracers</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=watermass-geometry onchange="change();">&nbsp;watermass geometry</label></li><li><label class="dropdown-item checkbox domains"><input type="checkbox" rel=wavelet-analysis onchange="change();">&nbsp;wavelet analysis</label></li></ul>
    </div>
    ...
    Formats</button>
    <ul class="dropdown-menu" aria-labelledby="formatsDropdown"><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=2k-proxy-composite onchange="change();">&nbsp;2k Proxy Composite</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=ancientwmg onchange="change();">&nbsp;AncientWMG</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=c-itrace onchange="change();">&nbsp;C-iTRACE</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=detecting-paleoclimate-transitions-with-lerm onchange="change();">&nbsp;Detecting Paleoclimate Transitions with LERM</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=extras onchange="change();">&nbsp;Extras</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=figures onchange="change();">&nbsp;Figures</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=lmr-cmip6 onchange="change();">&nbsp;LMR-CMIP6</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=lifehacks onchange="change();">&nbsp;Lifehacks</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=pyleoclim-science onchange="change();">&nbsp;Pyleoclim science</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=science-bits onchange="change();">&nbsp;Science Bits</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=science-workflows onchange="change();">&nbsp;Science Workflows</label></li></ul>
    </div>
    ...
    Packages</button>
    <ul class="dropdown-menu" aria-labelledby="packagesDropdown"><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=aws onchange="change();">&nbsp;AWS</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=ammonyte onchange="change();">&nbsp;ammonyte</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=basemap onchange="change();">&nbsp;basemap</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=cartopy onchange="change();">&nbsp;cartopy</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=cfr onchange="change();">&nbsp;cfr</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=climlab onchange="change();">&nbsp;climlab</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=intake onchange="change();">&nbsp;intake</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=ipywidgets onchange="change();">&nbsp;ipywidgets</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=matplotlib onchange="change();">&nbsp;matplotlib</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=numpy onchange="change();">&nbsp;numpy</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=pandas onchange="change();">&nbsp;pandas</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=pyleoclim onchange="change();">&nbsp;pyleoclim</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=pylipd onchange="change();">&nbsp;pylipd</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=scikit-learn onchange="change();">&nbsp;scikit-learn</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=scipy onchange="change();">&nbsp;scipy</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=seaborn onchange="change();">&nbsp;seaborn</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=sqlalchemy onchange="change();">&nbsp;sqlalchemy</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=xarray onchange="change();">&nbsp;xarray</label></li></ul>
    </div>
...
.. grid:: 1 2 2 2
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: C-iTrace Paleobook
                            ...
                            :bdg-primary:`oceanography`, :bdg-primary:`watermass geometry`, :bdg-primary:`tracers`, :bdg-primary:`C14`, :bdg-primary:`Mystery Interval`, :bdg-primary:`clustering`, :bdg-primary:`eNd`, :bdg-primary:`model output`, :bdg-primary:`Deglaciation`, :bdg-primary:`Paleoceanography`, :bdg-primary:`machine learning`, :bdg-primary:`data viz`, :bdg-primary:`coordinate systems`, :bdg-secondary:`scikit-learn`, :bdg-secondary:`intake`, :bdg-secondary:`matplotlib`, :bdg-secondary:`pandas`, :bdg-secondary:`seaborn`, :bdg-secondary:`xarray`, :bdg-secondary:`cartopy`, :bdg-info:`Science Bits`, :bdg-info:`C-iTRACE`, :bdg-info:`Lifehacks`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: LMR-CMIP6 Paleobook
                            ...
                            :bdg-primary:`AWS`, :bdg-primary:`CMIP6`, :bdg-primary:`LMR`, :bdg-primary:`model output`, :bdg-primary:`Holocene climate`, :bdg-primary:`Volcanic Input`, :bdg-primary:`cloud-ready data`, :bdg-primary:`data viz`, :bdg-primary:`coordinate systems`, :bdg-secondary:`AWS`, :bdg-secondary:`intake`, :bdg-secondary:`matplotlib`, :bdg-secondary:`pandas`, :bdg-secondary:`ipywidgets`, :bdg-secondary:`xarray`, :bdg-secondary:`pyleoclim`, :bdg-secondary:`cartopy`, :bdg-info:`Science Bits`, :bdg-info:`LMR-CMIP6`, :bdg-info:`Lifehacks`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        :tags: 2k-proxy-composite science-workflows cfr numpy pandas proxy-composite pyleoclim seaborn temperature
                        ...
                        .. card:: Reproducing the Hockey Stick - Proxy composite over the past 2,000 years using the cfr package
                            ...
                            :bdg-primary:`proxy composite`, :bdg-primary:`temperature`, :bdg-secondary:`pandas`, :bdg-secondary:`cfr`, :bdg-secondary:`seaborn`, :bdg-secondary:`numpy`, :bdg-secondary:`pyleoclim`, :bdg-info:`2k Proxy Composite`, :bdg-info:`Science Workflows`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Watermass Geometry Proto exercise
                            ...
                            :bdg-primary:`endmember mixing`, :bdg-primary:`watermass geometry`, :bdg-primary:`clustering`, :bdg-primary:`tracers`, :bdg-secondary:`scikit-learn`, :bdg-secondary:`sqlalchemy`, :bdg-secondary:`basemap`, :bdg-secondary:`matplotlib`, :bdg-secondary:`scipy`, :bdg-secondary:`pandas`, :bdg-info:`Science Bits`, :bdg-info:`AncientWMG`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Detecting paleoclimate transitions with Laplacian Eigenmaps of Recurrence Matrices (LERM)
                            ...
                            :bdg-primary:`data viz`, :bdg-secondary:`matplotlib`, :bdg-secondary:`pyleoclim`, :bdg-secondary:`ammonyte`, :bdg-info:`Extras`, :bdg-info:`Figures`, :bdg-info:`Detecting Paleoclimate Transitions with LERM`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        :tags: pyleoclim-science science-workflows age-uncertainty cartopy climlab correlation cross-wavelet-analysis insolation model-output model-data-comparison paleoceanography paleoclimate pyleoclim pylipd spectral-analysis wavelet-analysis xarray
                    
                        .. card:: Reproducible workflows using the Pyleoclim package
                            ...
                            :bdg-primary:`insolation`, :bdg-primary:`paleoclimate`, :bdg-primary:`age uncertainty`, :bdg-primary:`cross-wavelet analysis`, :bdg-primary:`wavelet analysis`, :bdg-primary:`model output`, :bdg-primary:`spectral analysis`, :bdg-primary:`paleoceanography`, :bdg-primary:`correlation`, :bdg-primary:`model-data comparison`, :bdg-secondary:`pylipd`, :bdg-secondary:`xarray`, :bdg-secondary:`pyleoclim`, :bdg-secondary:`cartopy`, :bdg-secondary:`climlab`, :bdg-info:`Pyleoclim science`, :bdg-info:`Science Workflows`
...
.. grid:: 1 2 2 2
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        :tags: 2k-proxy-composite science-workflows cfr notebook numpy pandas proxy-composite pyleoclim seaborn temperature
                        ...
                        .. card:: Hockey Stick
                            ...
                            :bdg-primary:`proxy composite`, :bdg-primary:`temperature`, :bdg-secondary:`numpy`, :bdg-secondary:`seaborn`, :bdg-secondary:`pandas`, :bdg-secondary:`pyleoclim`, :bdg-secondary:`cfr`, :bdg-info:`notebook`, :bdg-info:`Science Workflows`, :bdg-info:`2k Proxy Composite`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Capstone notebook
                            ...
                            :bdg-primary:`watermass geometry`, :bdg-primary:`tracers`, :bdg-primary:`endmember mixing`, :bdg-secondary:`basemap`, :bdg-secondary:`scipy`, :bdg-secondary:`matplotlib`, :bdg-secondary:`pandas`, :bdg-secondary:`sqlalchemy`, :bdg-info:`notebook`, :bdg-info:`Science Bits`, :bdg-info:`AncientWMG`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Cluster Centers
                            ...
                            :bdg-primary:`clustering`, :bdg-primary:`watermass geometry`, :bdg-secondary:`basemap`, :bdg-secondary:`scikit-learn`, :bdg-secondary:`matplotlib`, :bdg-info:`notebook`, :bdg-info:`Science Bits`, :bdg-info:`AncientWMG`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Figure_1
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Figures/Figure_1
                            :img-top: https://raw.githubusercontent.com/alexkjames/Detecting_Paleoclimate_Transitions_with_LERM/main/thumbnails/full_workflow.png
                            :img-alt: full_workflow
                            
                            :bdg-primary:`data viz`, :bdg-secondary:`matplotlib`, :bdg-secondary:`pyleoclim`, :bdg-secondary:`ammonyte`, :bdg-info:`notebook`, :bdg-info:`Figures`, :bdg-info:`Detecting Paleoclimate Transitions with LERM`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Figure_2
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Figures/Figure_2
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Figure_3
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Figures/Figure_3
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Figure_4
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Figures/Figure_4
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Figure_5
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Figures/Figure_5
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Figure_6
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Figures/Figure_6
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Figure_7
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Figures/Figure_7
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Figure_8
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Figures/Figure_8
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Holocene_Ice_Analysis
                            ...
                            :bdg-primary:`data viz`, :bdg-secondary:`matplotlib`, :bdg-secondary:`pyleoclim`, :bdg-secondary:`ammonyte`, :bdg-info:`notebook`, :bdg-info:`Extras`, :bdg-info:`Detecting Paleoclimate Transitions with LERM`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        :tags: pyleoclim-science science-workflows climlab cross-wavelet-analysis insolation notebook paleoceanography pyleoclim pylipd spectral-analysis wavelet-analysis xarray
                        ...
                        .. card:: Chasing cyclicities
                            ...
                            :bdg-primary:`spectral analysis`, :bdg-primary:`wavelet analysis`, :bdg-primary:`cross-wavelet analysis`, :bdg-primary:`insolation`, :bdg-primary:`paleoceanography`, :bdg-secondary:`xarray`, :bdg-secondary:`pyleoclim`, :bdg-secondary:`pylipd`, :bdg-secondary:`climlab`, :bdg-info:`notebook`, :bdg-info:`Science Workflows`, :bdg-info:`Pyleoclim science`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        :tags: pyleoclim-science science-workflows model-output model-data-comparison notebook paleoclimate pyleoclim spectral-analysis xarray
                        ...
                        .. card:: Model-Data Confrontation
                            ...
                            :bdg-primary:`model output`, :bdg-primary:`spectral analysis`, :bdg-primary:`model-data comparison`, :bdg-primary:`paleoclimate`, :bdg-secondary:`xarray`, :bdg-secondary:`pyleoclim`, :bdg-info:`notebook`, :bdg-info:`Science Workflows`, :bdg-info:`Pyleoclim science`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        :tags: pyleoclim-science science-workflows age-uncertainty cartopy correlation notebook paleoclimate pyleoclim pylipd xarray
                        ...
                        .. card:: Correlations at Sea
                            ...
                            :bdg-primary:`paleoclimate`, :bdg-primary:`correlation`, :bdg-primary:`age uncertainty`, :bdg-secondary:`xarray`, :bdg-secondary:`pyleoclim`, :bdg-secondary:`cartopy`, :bdg-secondary:`pylipd`, :bdg-info:`notebook`, :bdg-info:`Science Workflows`, :bdg-info:`Pyleoclim science`
