...
.. grid:: 1 2 2 2
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: C-iTrace Paleobook :bdg-danger:`C-iTRACE` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`machine learning` :bdg-emerald:`Deglaciation` :bdg-emerald:`Paleoceanography` :bdg-emerald:`Mystery Interval` :bdg-emerald:`eNd` :bdg-emerald:`tracers` :bdg-emerald:`model output` :bdg-emerald:`data viz` :bdg-emerald:`clustering` :bdg-emerald:`watermass geometry` :bdg-emerald:`C14` :bdg-emerald:`coordinate systems` :bdg-emerald:`oceanography`, :bdg-success:`pandas` :bdg-success:`seaborn` :bdg-success:`scikit-learn` :bdg-success:`matplotlib` :bdg-success:`intake` :bdg-success:`xarray` :bdg-success:`cartopy`, :bdg-primary:`Science Bits` :bdg-primary:`Lifehacks`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: LMR-CMIP6 Paleobook :bdg-danger:`LMR-CMIP6` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`LMR` :bdg-emerald:`Volcanic Input` :bdg-emerald:`CMIP6` :bdg-emerald:`AWS` :bdg-emerald:`cloud-ready data` :bdg-emerald:`model output` :bdg-emerald:`data viz` :bdg-emerald:`Holocene climate` :bdg-emerald:`coordinate systems`, :bdg-success:`pandas` :bdg-success:`AWS` :bdg-success:`pyleoclim` :bdg-success:`ipywidgets` :bdg-success:`matplotlib` :bdg-success:`intake` :bdg-success:`xarray` :bdg-success:`cartopy`, :bdg-primary:`Science Bits` :bdg-primary:`Lifehacks`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducing the Hockey Stick - Proxy composite over the past 2,000 years using the cfr package :bdg-danger:`2k Proxy Composite` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`temperature` :bdg-emerald:`proxy composite`, :bdg-success:`pandas` :bdg-success:`seaborn` :bdg-success:`pyleoclim` :bdg-success:`numpy` :bdg-success:`cfr`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Watermass Geometry Proto exercise :bdg-danger:`PrototypeWMG` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`tracers` :bdg-emerald:`watermass geometry` :bdg-emerald:`endmember mixing` :bdg-emerald:`clustering`, :bdg-success:`pandas` :bdg-success:`scikit-learn` :bdg-success:`basemap` :bdg-success:`matplotlib` :bdg-success:`scipy` :bdg-success:`sqlalchemy`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Detecting paleoclimate transitions with Laplacian Eigenmaps of Recurrence Matrices (LERM) :bdg-danger:`Detecting Paleoclimate Transitions with LERM` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data viz`, :bdg-success:`matplotlib` :bdg-success:`pyleoclim` :bdg-success:`ammonyte`, :bdg-primary:`Main Analysis` :bdg-primary:`Extras`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducible workflows using the Pyleoclim package :bdg-danger:`Pyleoclim science` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`correlation` :bdg-emerald:`spectral analysis` :bdg-emerald:`insolation` :bdg-emerald:`model output` :bdg-emerald:`age uncertainty` :bdg-emerald:`paleoceanography` :bdg-emerald:`model-data comparison` :bdg-emerald:`cross-wavelet analysis` :bdg-emerald:`wavelet analysis` :bdg-emerald:`paleoclimate`, :bdg-success:`climlab` :bdg-success:`pyleoclim` :bdg-success:`pylipd` :bdg-success:`xarray` :bdg-success:`cartopy`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Coral Sr/Ca Calibration - An Example from Dry Tortugas :bdg-danger:`Coral Sr/Ca calibration` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`Bayesian Statistics` :bdg-emerald:`Calibration` :bdg-emerald:`Sr/Ca` :bdg-emerald:`Paleocenography` :bdg-emerald:`paleoceanography` :bdg-emerald:`Statistics` :bdg-emerald:`coral` :bdg-emerald:`calibration`, :bdg-success:`pandas` :bdg-success:`statsmodel` :bdg-success:`Great Tables` :bdg-success:`pyleoclim` :bdg-success:`matplotlib` :bdg-success:`arviz` :bdg-success:`pymc`, :bdg-primary:`Calibration` :bdg-primary:`Getting Started`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Investigating interhemispheric precipitation changes over the past millennium :bdg-danger:`PaleoPCA` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`modeling` :bdg-emerald:`PCA` :bdg-emerald:`paleoceanography`, :bdg-success:`pandas` :bdg-success:`pyleoclim` :bdg-success:`eofs` :bdg-success:`matplotlib` :bdg-success:`xarray` :bdg-success:`cartopy`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Comparing Paleoclimate Ensembles :bdg-danger:`PaleoEnsembles` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`timeseries modeling` :bdg-emerald:`paleoclimatology` :bdg-emerald:`statistics` :bdg-emerald:`PaMoDaCo` :bdg-emerald:`reconstruction` :bdg-emerald:`PMIP` :bdg-emerald:`data viz` :bdg-emerald:`Common Era` :bdg-emerald:`data assimilation`, :bdg-success:`pandas` :bdg-success:`seaborn` :bdg-success:`pyleoclim` :bdg-success:`matplotlib` :bdg-success:`scipy` :bdg-success:`statsmodels` :bdg-success:`pens`, :bdg-primary:`Paleoclimate Applications` :bdg-primary:`Plume Distance` :bdg-primary:`Temporal Interpretation` :bdg-primary:`Motivation`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Regime Shifts in Holocene Paleohydrology as Recorded by Asian Speleothems :bdg-danger:`Asian Speleothem Coherency` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data viz` :bdg-emerald:`data wrangling` :bdg-emerald:`data analysis`, :bdg-success:`ammonyte` :bdg-success:`basemap` :bdg-success:`pyleoclim` :bdg-success:`matplotlib` :bdg-success:`pyLiPD` :bdg-success:`pylipd`, :bdg-primary:`Exploring the Data` :bdg-primary:`Main Analysis` :bdg-primary:`Loading Data`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: geoChronR Vignettes (McKay et al., 2021) :bdg-danger:`geoChronR` :bdg-mauve:`R`
                            ...
                            :bdg-emerald:`uncertainty quantification` :bdg-emerald:`ensemble` :bdg-emerald:`dimension reduction` :bdg-emerald:`age modeling` :bdg-emerald:`wavelets` :bdg-emerald:`correlation` :bdg-emerald:`regression` :bdg-emerald:`spectral analysis` :bdg-emerald:`data wrangling` :bdg-emerald:`mapping` :bdg-emerald:`LiPD` :bdg-emerald:`age uncertainty` :bdg-emerald:`visualization` :bdg-emerald:`PCA` :bdg-emerald:`calibration` :bdg-emerald:`tidyverse`, :bdg-success:`readr` :bdg-success:`dplyr` :bdg-success:`oxcAAR` :bdg-success:`ggplot2` :bdg-success:`purrr` :bdg-success:`lipdR`, :bdg-primary:`Extensions` :bdg-primary:`Core Methods` :bdg-primary:`Data Manipulation`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        :tags: assimilating-pages2k-with-cfr data-assembly data-assimilation validation-and-comparison cfr data-analysis data-assimilation data-viz data-wrangling matplotlib python xarray
                        :outline: teal
                        ...
                        .. card:: Assimilating PAGES 2k records with LinkedEarth tools :bdg-danger:`Assimilating PAGES2k with CFR` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data analysis` :bdg-emerald:`data wrangling` :bdg-emerald:`data viz` :bdg-emerald:`data assimilation`, :bdg-success:`xarray` :bdg-success:`cfr` :bdg-success:`matplotlib`, :bdg-primary:`Data Assembly` :bdg-primary:`Validation and Comparison` :bdg-primary:`Data Assimilation`
...
.. grid:: 1 2 2 2
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        :tags: assimilating-pages2k-with-cfr validation-and-comparison cfr data-analysis data-viz matplotlib notebook python xarray
                        :outline: teal
                        ...
                        .. card:: Reconstruction Validation :bdg-danger:`Assimilating PAGES2k with CFR` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data viz` :bdg-emerald:`data analysis`, :bdg-success:`cfr` :bdg-success:`xarray` :bdg-success:`matplotlib`, :bdg-primary:`Validation and Comparison`
