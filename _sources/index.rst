...
.. grid:: 1 2 2 2
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: C-iTrace Paleobook :bdg-danger:`C-iTRACE` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data viz` :bdg-emerald:`Mystery Interval` :bdg-emerald:`Deglaciation` :bdg-emerald:`Paleoceanography` :bdg-emerald:`model output` :bdg-emerald:`watermass geometry` :bdg-emerald:`oceanography` :bdg-emerald:`coordinate systems` :bdg-emerald:`clustering` :bdg-emerald:`C14` :bdg-emerald:`machine learning` :bdg-emerald:`tracers` :bdg-emerald:`eNd`, :bdg-success:`intake` :bdg-success:`scikit-learn` :bdg-success:`xarray` :bdg-success:`matplotlib` :bdg-success:`seaborn` :bdg-success:`pandas` :bdg-success:`cartopy`, :bdg-primary:`Science Bits` :bdg-primary:`Lifehacks`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: LMR-CMIP6 Paleobook :bdg-danger:`LMR-CMIP6` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data viz` :bdg-emerald:`cloud-ready data` :bdg-emerald:`LMR` :bdg-emerald:`CMIP6` :bdg-emerald:`model output` :bdg-emerald:`Volcanic Input` :bdg-emerald:`coordinate systems` :bdg-emerald:`Holocene climate` :bdg-emerald:`AWS`, :bdg-success:`ipywidgets` :bdg-success:`pyleoclim` :bdg-success:`xarray` :bdg-success:`matplotlib` :bdg-success:`intake` :bdg-success:`AWS` :bdg-success:`pandas` :bdg-success:`cartopy`, :bdg-primary:`Science Bits` :bdg-primary:`Lifehacks`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducing the Hockey Stick - Proxy composite over the past 2,000 years using the cfr package :bdg-danger:`2k Proxy Composite` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`proxy composite` :bdg-emerald:`temperature`, :bdg-success:`cfr` :bdg-success:`numpy` :bdg-success:`pyleoclim` :bdg-success:`seaborn` :bdg-success:`pandas`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Watermass Geometry Proto exercise :bdg-danger:`PrototypeWMG` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`clustering` :bdg-emerald:`tracers` :bdg-emerald:`watermass geometry` :bdg-emerald:`endmember mixing`, :bdg-success:`sqlalchemy` :bdg-success:`scikit-learn` :bdg-success:`scipy` :bdg-success:`matplotlib` :bdg-success:`basemap` :bdg-success:`pandas`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Detecting paleoclimate transitions with Laplacian Eigenmaps of Recurrence Matrices (LERM) :bdg-danger:`Detecting Paleoclimate Transitions with LERM` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data viz`, :bdg-success:`ammonyte` :bdg-success:`matplotlib` :bdg-success:`pyleoclim`, :bdg-primary:`Extras` :bdg-primary:`Main Analysis`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducible workflows using the Pyleoclim package :bdg-danger:`Pyleoclim science` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`paleoclimate` :bdg-emerald:`paleoceanography` :bdg-emerald:`model output` :bdg-emerald:`age uncertainty` :bdg-emerald:`insolation` :bdg-emerald:`spectral analysis` :bdg-emerald:`wavelet analysis` :bdg-emerald:`model-data comparison` :bdg-emerald:`cross-wavelet analysis` :bdg-emerald:`correlation`, :bdg-success:`pyleoclim` :bdg-success:`climlab` :bdg-success:`xarray` :bdg-success:`pylipd` :bdg-success:`cartopy`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Coral Sr/Ca Calibration - An Example from Dry Tortugas :bdg-danger:`Coral Sr/Ca calibration` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`Paleocenography` :bdg-emerald:`paleoceanography` :bdg-emerald:`Calibration` :bdg-emerald:`Bayesian Statistics` :bdg-emerald:`coral` :bdg-emerald:`Sr/Ca` :bdg-emerald:`calibration` :bdg-emerald:`Statistics`, :bdg-success:`Great Tables` :bdg-success:`statsmodel` :bdg-success:`arviz` :bdg-success:`pyleoclim` :bdg-success:`matplotlib` :bdg-success:`pymc` :bdg-success:`pandas`, :bdg-primary:`Getting Started` :bdg-primary:`Calibration`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Investigating interhemispheric precipitation changes over the past millennium :bdg-danger:`PaleoPCA` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`paleoceanography` :bdg-emerald:`PCA` :bdg-emerald:`modeling`, :bdg-success:`pyleoclim` :bdg-success:`xarray` :bdg-success:`matplotlib` :bdg-success:`cartopy` :bdg-success:`eofs` :bdg-success:`pandas`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Comparing Paleoclimate Ensembles :bdg-danger:`PaleoEnsembles` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data viz` :bdg-emerald:`data assimilation` :bdg-emerald:`PMIP` :bdg-emerald:`statistics` :bdg-emerald:`reconstruction` :bdg-emerald:`Common Era` :bdg-emerald:`timeseries modeling` :bdg-emerald:`PaMoDaCo` :bdg-emerald:`paleoclimatology`, :bdg-success:`pyleoclim` :bdg-success:`pens` :bdg-success:`scipy` :bdg-success:`matplotlib` :bdg-success:`statsmodels` :bdg-success:`seaborn` :bdg-success:`pandas`, :bdg-primary:`Paleoclimate Applications` :bdg-primary:`Temporal Interpretation` :bdg-primary:`Plume Distance` :bdg-primary:`Motivation`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Regime Shifts in Holocene Paleohydrology as Recorded by Asian Speleothems :bdg-danger:`Asian Speleothem Coherency` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data viz` :bdg-emerald:`data wrangling` :bdg-emerald:`data analysis`, :bdg-success:`pyleoclim` :bdg-success:`pyLiPD` :bdg-success:`matplotlib` :bdg-success:`pylipd` :bdg-success:`ammonyte` :bdg-success:`basemap`, :bdg-primary:`Loading Data` :bdg-primary:`Main Analysis` :bdg-primary:`Exploring the Data`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: geoChronR Vignettes (McKay et al., 2021) :bdg-danger:`geoChronR` :bdg-mauve:`R`
                            ...
                            :bdg-emerald:`uncertainty quantification` :bdg-emerald:`PCA` :bdg-emerald:`age modeling` :bdg-emerald:`dimension reduction` :bdg-emerald:`data wrangling` :bdg-emerald:`regression` :bdg-emerald:`mapping` :bdg-emerald:`wavelets` :bdg-emerald:`tidyverse` :bdg-emerald:`ensemble` :bdg-emerald:`age uncertainty` :bdg-emerald:`visualization` :bdg-emerald:`spectral analysis` :bdg-emerald:`LiPD` :bdg-emerald:`calibration` :bdg-emerald:`correlation`, :bdg-success:`oxcAAR` :bdg-success:`readr` :bdg-success:`lipdR` :bdg-success:`dplyr` :bdg-success:`ggplot2` :bdg-success:`purrr`, :bdg-primary:`Data Manipulation` :bdg-primary:`Core Methods` :bdg-primary:`Extensions`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Assimilating PAGES 2k records with LinkedEarth tools :bdg-danger:`Assimilating PAGES2k with CFR` :bdg-teal:`python`
                            :link: https://tanaya-g.github.io/pages2k_cfr_pb/README.html
                            :img-top: https://raw.githubusercontent.com/tanaya-g/pages2k_cfr_pb/main/thumbnails/consensus.png
                            :img-alt: consensus.png
                            
                            :bdg-emerald:`data assimilation` :bdg-emerald:`data viz` :bdg-emerald:`data wrangling` :bdg-emerald:`data analysis`, :bdg-success:`cfr` :bdg-success:`xarray` :bdg-success:`matplotlib` :bdg-success:`pens`, :bdg-primary:`Validation and Comparison` :bdg-primary:`Data Assimilation` :bdg-primary:`Data Assembly`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Global Speleothem Analysis Reveals State-Dependent Rainbelt Response to Orbital Forcing :bdg-danger:`Global Speleothem Analysis` :bdg-teal:`python`
                            :link: https://alexkjames.github.io/Speleothems_and_Insolation/intro.html
                            :img-top: https://raw.githubusercontent.com/alexkjames/Speleothems_and_Insolation/main/thumbnails/logo.png
                            :img-alt: logo.png
                            
                            :bdg-emerald:`data viz` :bdg-emerald:`data wrangling` :bdg-emerald:`paleoclimate` :bdg-emerald:`signal processing` :bdg-emerald:`statistics` :bdg-emerald:`data analysis` :bdg-emerald:`geospatial`, :bdg-success:`numpy` :bdg-success:`pyleoclim` :bdg-success:`climlab` :bdg-success:`matplotlib` :bdg-success:`pylipd` :bdg-success:`cartopy`, :bdg-primary:`Correlation Analysis` :bdg-primary:`Exploring the Data` :bdg-primary:`Global Coherence Analysis` :bdg-primary:`Heuristic Examples`
...
.. grid:: 1 2 2 2
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: ProxyDatabase from Pickle :bdg-danger:`Assimilating PAGES2k with CFR` :bdg-teal:`python`
                            :link: https://tanaya-g.github.io/pages2k_cfr_pb/notebooks/data_assembly/C01_a_db_assembly_Tardif2019_pickle
                            :img-top: https://raw.githubusercontent.com/tanaya-g/pages2k_cfr_pb/main/thumbnails/PAGES2k_logo.png
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: ProxyDatabase from cfr :bdg-danger:`Assimilating PAGES2k with CFR` :bdg-teal:`python`
                            :link: https://tanaya-g.github.io/pages2k_cfr_pb/notebooks/data_assembly/C01_b_db_assembly_cfr_PAGES2k
                            :img-top: https://raw.githubusercontent.com/tanaya-g/pages2k_cfr_pb/main/thumbnails/PAGES2k_logo.png
                            :img-alt: PAGES2k_logo.png
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Data Assimilation :bdg-danger:`Assimilating PAGES2k with CFR` :bdg-teal:`python`
                            :link: https://tanaya-g.github.io/pages2k_cfr_pb/notebooks/data_assimilation/C02_data_assimilation
                            :img-top: https://raw.githubusercontent.com/tanaya-g/pages2k_cfr_pb/main/thumbnails/gmst_quick.png
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reconstruction Validation :bdg-danger:`Assimilating PAGES2k with CFR` :bdg-teal:`python`
                            :link: https://tanaya-g.github.io/pages2k_cfr_pb/notebooks/validation/C03_a_validation
                            :img-top: https://raw.githubusercontent.com/tanaya-g/pages2k_cfr_pb/main/thumbnails/pens.png
                            :img-alt: pens.png
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Proxy Database Comparison :bdg-danger:`Assimilating PAGES2k with CFR` :bdg-teal:`python`
                            :link: https://tanaya-g.github.io/pages2k_cfr_pb/notebooks/validation/C03_b_comparison
                            :img-top: https://raw.githubusercontent.com/tanaya-g/pages2k_cfr_pb/main/thumbnails/proxydb_compare.png
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Load Data :bdg-danger:`Global Speleothem Analysis` :bdg-teal:`python`
                            :link: https://alexkjames.github.io/Speleothems_and_Insolation/notebooks/Explore_Data/Load_Data
                            :img-top: https://raw.githubusercontent.com/alexkjames/Speleothems_and_Insolation/main/thumbnails/logo.png
                            :img-alt: logo.png
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Mapping Data :bdg-danger:`Global Speleothem Analysis` :bdg-teal:`python`
                            :link: https://alexkjames.github.io/Speleothems_and_Insolation/notebooks/Explore_Data/Mapping_Data
                            :img-top: https://raw.githubusercontent.com/alexkjames/Speleothems_and_Insolation/main/thumbnails/lsd_map.png
                            :img-alt: lsd_map.png
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Plotting Raw Data :bdg-danger:`Global Speleothem Analysis` :bdg-teal:`python`
                            :link: https://alexkjames.github.io/Speleothems_and_Insolation/notebooks/Explore_Data/Plotting_Raw_Data
                            :img-top: https://raw.githubusercontent.com/alexkjames/Speleothems_and_Insolation/main/thumbnails/lsd_stack.png
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Toy Data Heuristic :bdg-danger:`Global Speleothem Analysis` :bdg-teal:`python`
                            :link: https://alexkjames.github.io/Speleothems_and_Insolation/notebooks/Heuristics/Toy_Data_Heuristic
                            :img-top: https://raw.githubusercontent.com/alexkjames/Speleothems_and_Insolation/main/thumbnails/murmuration_helper_new.png
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Leviathan Cave and Insolation :bdg-danger:`Global Speleothem Analysis` :bdg-teal:`python`
                            :link: https://alexkjames.github.io/Speleothems_and_Insolation/notebooks/Heuristics/Leviathan_Cave_and_Insolation
                            :img-top: https://raw.githubusercontent.com/alexkjames/Speleothems_and_Insolation/main/thumbnails/leviathan_lag.png
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Global Coherence Analysis :bdg-danger:`Global Speleothem Analysis` :bdg-teal:`python`
                            :link: https://alexkjames.github.io/Speleothems_and_Insolation/notebooks/Coherence/Global_Coherence_Analysis
                            :img-top: https://raw.githubusercontent.com/alexkjames/Speleothems_and_Insolation/main/thumbnails/coherence.png
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Global Coherence MIS :bdg-danger:`Global Speleothem Analysis` :bdg-teal:`python`
                            :link: https://alexkjames.github.io/Speleothems_and_Insolation/notebooks/Coherence/Global_Coherence_MIS
                            :img-top: https://raw.githubusercontent.com/alexkjames/Speleothems_and_Insolation/main/thumbnails/MIS_asymmetry_fig.png
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Global Coherence Sensitivity :bdg-danger:`Global Speleothem Analysis` :bdg-teal:`python`
                            :link: https://alexkjames.github.io/Speleothems_and_Insolation/notebooks/Coherence/Global_Coherence_Sensitivity_and_Significance
                            :img-top: https://raw.githubusercontent.com/alexkjames/Speleothems_and_Insolation/main/thumbnails/coh_surrogate_violin.png
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Interglacial Correlation :bdg-danger:`Global Speleothem Analysis` :bdg-teal:`python`
                            :link: https://alexkjames.github.io/Speleothems_and_Insolation/notebooks/Correlation/Interglacial_Correlation_Analysis
                            :img-top: https://raw.githubusercontent.com/alexkjames/Speleothems_and_Insolation/main/thumbnails/geo_ms_interglacial_correlation.png
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Glaciation Correlation :bdg-danger:`Global Speleothem Analysis` :bdg-teal:`python`
                            :link: https://alexkjames.github.io/Speleothems_and_Insolation/Glaciation_Correlation_Analysis
                            :img-top: https://raw.githubusercontent.com/alexkjames/Speleothems_and_Insolation/main/thumbnails/geo_ms_glacial_correlation.png
