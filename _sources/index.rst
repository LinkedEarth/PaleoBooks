...
.. raw:: html
    ...
    Packages</button>
    <ul class="dropdown-menu" aria-labelledby="packagesDropdown"><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=aws onchange="change();">&nbsp;AWS</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=ammonyte onchange="change();">&nbsp;ammonyte</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=basemap onchange="change();">&nbsp;basemap</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=cartopy onchange="change();">&nbsp;cartopy</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=cfr onchange="change();">&nbsp;cfr</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=intake onchange="change();">&nbsp;intake</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=ipywidgets onchange="change();">&nbsp;ipywidgets</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=matplotlib onchange="change();">&nbsp;matplotlib</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=numpy onchange="change();">&nbsp;numpy</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=pandas onchange="change();">&nbsp;pandas</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=pyleoclim onchange="change();">&nbsp;pyleoclim</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=scikit-learn onchange="change();">&nbsp;scikit-learn</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=scipy onchange="change();">&nbsp;scipy</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=seaborn onchange="change();">&nbsp;seaborn</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=sqlalchemy onchange="change();">&nbsp;sqlalchemy</label></li><li><label class="dropdown-item checkbox packages"><input type="checkbox" rel=xarray onchange="change();">&nbsp;xarray</label></li></ul>
    </div>
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: C-iTrace Paleobook
                            ...
                            :bdg-primary:`watermass geometry`, :bdg-primary:`eNd`, :bdg-primary:`C14`, :bdg-primary:`data viz`, :bdg-primary:`clustering`, :bdg-primary:`oceanography`, :bdg-primary:`coordinate systems`, :bdg-primary:`machine learning`, :bdg-primary:`Deglaciation`, :bdg-primary:`Paleoceanography`, :bdg-primary:`model output`, :bdg-primary:`tracers`, :bdg-primary:`Mystery Interval`, :bdg-secondary:`cartopy`, :bdg-secondary:`intake`, :bdg-secondary:`scikit-learn`, :bdg-secondary:`seaborn`, :bdg-secondary:`pandas`, :bdg-secondary:`matplotlib`, :bdg-secondary:`xarray`, :bdg-info:`Science Bits`, :bdg-info:`C-iTRACE`, :bdg-info:`Lifehacks`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: LMR-CMIP6 Paleobook
                            ...
                            :bdg-primary:`Holocene climate`, :bdg-primary:`CMIP6`, :bdg-primary:`data viz`, :bdg-primary:`coordinate systems`, :bdg-primary:`AWS`, :bdg-primary:`LMR`, :bdg-primary:`Volcanic Input`, :bdg-primary:`model output`, :bdg-primary:`cloud-ready data`, :bdg-secondary:`cartopy`, :bdg-secondary:`intake`, :bdg-secondary:`pandas`, :bdg-secondary:`pyleoclim`, :bdg-secondary:`matplotlib`, :bdg-secondary:`ipywidgets`, :bdg-secondary:`AWS`, :bdg-secondary:`xarray`, :bdg-info:`LMR-CMIP6`, :bdg-info:`Science Bits`, :bdg-info:`Lifehacks`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducing the Hockey Stick - Proxy composite over the past 2,000 years using the cfr package
                            ...
                            :bdg-primary:`proxy composite`, :bdg-primary:`temperature`, :bdg-secondary:`seaborn`, :bdg-secondary:`pyleoclim`, :bdg-secondary:`pandas`, :bdg-secondary:`numpy`, :bdg-secondary:`cfr`, :bdg-info:`2k Proxy Composite`, :bdg-info:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Watermass Geometry Proto exercise
                            ...
                            :bdg-primary:`watermass geometry`, :bdg-primary:`tracers`, :bdg-primary:`endmember mixing`, :bdg-primary:`clustering`, :bdg-secondary:`scikit-learn`, :bdg-secondary:`pandas`, :bdg-secondary:`sqlalchemy`, :bdg-secondary:`matplotlib`, :bdg-secondary:`scipy`, :bdg-secondary:`basemap`, :bdg-info:`AncientWMG`, :bdg-info:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Detecting paleoclimate transitions with Laplacian Eigenmaps of Recurrence Matrices (LERM)
                            ...
                            :bdg-primary:`data viz`, :bdg-secondary:`ammonyte`, :bdg-secondary:`matplotlib`, :bdg-secondary:`pyleoclim`, :bdg-info:`Figures`, :bdg-info:`Extras`, :bdg-info:`Detecting Paleoclimate Transitions with LERM`
...
.. grid:: 1 2 2 2
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Capstone notebook
                            :link: https://jordanplanders.github.io/past_life_wmg/notebooks/Science_Bits/jlanders_capstone_fixed.html
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Cluster Centers
                            :link: https://jordanplanders.github.io/past_life_wmg/notebooks/Science_Bits/clustering_centers_on_raw.html
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Figure_1
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Figures/Figure_1.html
                            :img-top: https://raw.githubusercontent.com/alexkjames/Detecting_Paleoclimate_Transitions_with_LERM/main/thumbnails/full_workflow.png
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Figure_2
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Figures/Figure_2.html
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Figure_3
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Figures/Figure_3.html
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Figure_4
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Figures/Figure_4.html
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Figure_5
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Figures/Figure_5.html
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Figure_6
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Figures/Figure_6.html
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Figure_7
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Figures/Figure_7.html
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Figure_8
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Figures/Figure_8.html
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Holocene_Ice_Analysis
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Extras/Holocene_Ice_Analysis.html
                            :img-top: https://raw.githubusercontent.com/alexkjames/Detecting_Paleoclimate_Transitions_with_LERM/main/thumbnails/full_workflow.png
                            :img-alt: full_workflow
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Holocene_Ice_Window_Increment
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Extras/Holocene_Ice_Window_Increment.html
                            :img-top: https://raw.githubusercontent.com/alexkjames/Detecting_Paleoclimate_Transitions_with_LERM/main/thumbnails/full_workflow.png
                            :img-alt: full_workflow
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Holocene_Ice_Window_Size
                            :link: https://alexkjames.github.io/Detecting_Paleoclimate_Transitions_with_LERM/notebooks/Extras/Holocene_Ice_Window_Size.html
                            :img-top: https://raw.githubusercontent.com/alexkjames/Detecting_Paleoclimate_Transitions_with_LERM/main/thumbnails/full_workflow.png
                            :img-alt: full_workflow
