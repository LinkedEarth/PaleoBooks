                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: C-iTrace Paleobook :bdg-danger:`C-iTRACE` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`watermass geometry` :bdg-emerald:`eNd` :bdg-emerald:`data viz` :bdg-emerald:`model output` :bdg-emerald:`C14` :bdg-emerald:`coordinate systems` :bdg-emerald:`clustering` :bdg-emerald:`Mystery Interval` :bdg-emerald:`machine learning` :bdg-emerald:`Paleoceanography` :bdg-emerald:`tracers` :bdg-emerald:`oceanography` :bdg-emerald:`Deglaciation`, :bdg-success:`intake` :bdg-success:`scikit-learn` :bdg-success:`xarray` :bdg-success:`matplotlib` :bdg-success:`seaborn` :bdg-success:`pandas` :bdg-success:`cartopy`, :bdg-primary:`Lifehacks` :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: LMR-CMIP6 Paleobook :bdg-danger:`LMR-CMIP6` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`Volcanic Input` :bdg-emerald:`data viz` :bdg-emerald:`model output` :bdg-emerald:`coordinate systems` :bdg-emerald:`AWS` :bdg-emerald:`LMR` :bdg-emerald:`Holocene climate` :bdg-emerald:`CMIP6` :bdg-emerald:`cloud-ready data`, :bdg-success:`pyleoclim` :bdg-success:`intake` :bdg-success:`ipywidgets` :bdg-success:`xarray` :bdg-success:`AWS` :bdg-success:`pandas` :bdg-success:`matplotlib` :bdg-success:`cartopy`, :bdg-primary:`Lifehacks` :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducing the Hockey Stick - Proxy composite over the past 2,000 years using the cfr package :bdg-danger:`2k Proxy Composite` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`proxy composite` :bdg-emerald:`temperature`, :bdg-success:`pyleoclim` :bdg-success:`seaborn` :bdg-success:`pandas` :bdg-success:`cfr` :bdg-success:`numpy`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Watermass Geometry Proto exercise :bdg-danger:`PrototypeWMG` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`watermass geometry` :bdg-emerald:`tracers` :bdg-emerald:`clustering` :bdg-emerald:`endmember mixing`, :bdg-success:`sqlalchemy` :bdg-success:`scikit-learn` :bdg-success:`basemap` :bdg-success:`scipy` :bdg-success:`matplotlib` :bdg-success:`pandas`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Detecting paleoclimate transitions with Laplacian Eigenmaps of Recurrence Matrices (LERM) :bdg-danger:`Detecting Paleoclimate Transitions with LERM` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data viz`, :bdg-success:`pyleoclim` :bdg-success:`matplotlib` :bdg-success:`ammonyte`, :bdg-primary:`Extras` :bdg-primary:`Main Analysis`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducible workflows using the Pyleoclim package :bdg-danger:`Pyleoclim science` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`age uncertainty` :bdg-emerald:`cross-wavelet analysis` :bdg-emerald:`model output` :bdg-emerald:`spectral analysis` :bdg-emerald:`paleoceanography` :bdg-emerald:`insolation` :bdg-emerald:`correlation` :bdg-emerald:`wavelet analysis` :bdg-emerald:`paleoclimate` :bdg-emerald:`model-data comparison`, :bdg-success:`pyleoclim` :bdg-success:`xarray` :bdg-success:`pylipd` :bdg-success:`climlab` :bdg-success:`cartopy`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Coral Sr/Ca Calibration - An Example from Dry Tortugas :bdg-danger:`Coral Sr/Ca calibration` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`coral` :bdg-emerald:`calibration` :bdg-emerald:`paleoceanography` :bdg-emerald:`Calibration` :bdg-emerald:`Bayesian Statistics` :bdg-emerald:`Paleocenography` :bdg-emerald:`Sr/Ca` :bdg-emerald:`Statistics`, :bdg-success:`pyleoclim` :bdg-success:`pymc` :bdg-success:`arviz` :bdg-success:`Great Tables` :bdg-success:`matplotlib` :bdg-success:`pandas` :bdg-success:`statsmodel`, :bdg-primary:`Calibration` :bdg-primary:`Getting Started`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Investigating interhemispheric precipitation changes over the past millennium :bdg-danger:`PaleoPCA` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`modeling` :bdg-emerald:`PCA` :bdg-emerald:`paleoceanography`, :bdg-success:`pyleoclim` :bdg-success:`xarray` :bdg-success:`eofs` :bdg-success:`matplotlib` :bdg-success:`pandas` :bdg-success:`cartopy`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Comparing Paleoclimate Ensembles :bdg-danger:`PaleoEnsembles` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data assimilation` :bdg-emerald:`PMIP` :bdg-emerald:`data viz` :bdg-emerald:`reconstruction` :bdg-emerald:`Common Era` :bdg-emerald:`timeseries modeling` :bdg-emerald:`paleoclimatology` :bdg-emerald:`statistics` :bdg-emerald:`PaMoDaCo`, :bdg-success:`pyleoclim` :bdg-success:`scipy` :bdg-success:`pens` :bdg-success:`matplotlib` :bdg-success:`seaborn` :bdg-success:`pandas` :bdg-success:`statsmodels`, :bdg-primary:`Motivation` :bdg-primary:`Temporal Interpretation` :bdg-primary:`Paleoclimate Applications` :bdg-primary:`Plume Distance`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Regime Shifts in Holocene Paleohydrology as Recorded by Asian Speleothems :bdg-danger:`Asian Speleothem Coherency` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data viz` :bdg-emerald:`data analysis` :bdg-emerald:`data wrangling`, :bdg-success:`pyleoclim` :bdg-success:`basemap` :bdg-success:`pylipd` :bdg-success:`matplotlib` :bdg-success:`ammonyte` :bdg-success:`pyLiPD`, :bdg-primary:`Exploring the Data` :bdg-primary:`Loading Data` :bdg-primary:`Main Analysis`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: geoChronR Vignettes (McKay et al., 2021) :bdg-danger:`geoChronR` :bdg-mauve:`R`
                            ...
                            :bdg-emerald:`age uncertainty` :bdg-emerald:`calibration` :bdg-emerald:`visualization` :bdg-emerald:`ensemble` :bdg-emerald:`spectral analysis` :bdg-emerald:`tidyverse` :bdg-emerald:`correlation` :bdg-emerald:`wavelets` :bdg-emerald:`PCA` :bdg-emerald:`mapping` :bdg-emerald:`LiPD` :bdg-emerald:`age modeling` :bdg-emerald:`uncertainty quantification` :bdg-emerald:`data wrangling` :bdg-emerald:`regression` :bdg-emerald:`dimension reduction`, :bdg-success:`lipdR` :bdg-success:`readr` :bdg-success:`dplyr` :bdg-success:`oxcAAR` :bdg-success:`ggplot2` :bdg-success:`purrr`, :bdg-primary:`Extensions` :bdg-primary:`Data Manipulation` :bdg-primary:`Core Methods`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Assimilating PAGES 2k records with LinkedEarth tools :bdg-danger:`Assimilating PAGES2k with CFR` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data analysis` :bdg-emerald:`data viz` :bdg-emerald:`data wrangling` :bdg-emerald:`data assimilation`, :bdg-success:`pens` :bdg-success:`matplotlib` :bdg-success:`xarray` :bdg-success:`cfr`, :bdg-primary:`Validation and Comparison` :bdg-primary:`Data Assimilation` :bdg-primary:`Data Assembly`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Global Speleothem Analysis Reveals State-Dependent Hydrological Response to Orbital Forcing :bdg-danger:`Global Speleothem Analysis` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`geospatial` :bdg-emerald:`data viz` :bdg-emerald:`data analysis` :bdg-emerald:`paleoclimate` :bdg-emerald:`signal processing` :bdg-emerald:`data wrangling` :bdg-emerald:`statistics`, :bdg-success:`pyleoclim` :bdg-success:`pylipd` :bdg-success:`matplotlib` :bdg-success:`climlab` :bdg-success:`cartopy` :bdg-success:`numpy`, :bdg-primary:`Heuristic Examples` :bdg-primary:`Correlation Analysis` :bdg-primary:`Exploring the Data` :bdg-primary:`Global Coherence Analysis`
