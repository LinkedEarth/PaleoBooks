                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: C-iTrace Paleobook :bdg-danger:`C-iTRACE`
                            ...
                            :bdg-primary:`tracers` :bdg-primary:`machine learning` :bdg-primary:`watermass geometry` :bdg-primary:`Paleoceanography` :bdg-primary:`data viz` :bdg-primary:`Deglaciation` :bdg-primary:`Mystery Interval` :bdg-primary:`model output` :bdg-primary:`oceanography` :bdg-primary:`clustering` :bdg-primary:`coordinate systems` :bdg-primary:`C14` :bdg-primary:`eNd`, :bdg-secondary:`xarray` :bdg-secondary:`pandas` :bdg-secondary:`matplotlib` :bdg-secondary:`scikit-learn` :bdg-secondary:`cartopy` :bdg-secondary:`seaborn` :bdg-secondary:`intake`, :bdg-success:`Lifehacks` :bdg-success:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: LMR-CMIP6 Paleobook :bdg-danger:`LMR-CMIP6`
                            ...
                            :bdg-primary:`cloud-ready data` :bdg-primary:`LMR` :bdg-primary:`data viz` :bdg-primary:`model output` :bdg-primary:`CMIP6` :bdg-primary:`coordinate systems` :bdg-primary:`AWS` :bdg-primary:`Holocene climate` :bdg-primary:`Volcanic Input`, :bdg-secondary:`xarray` :bdg-secondary:`ipywidgets` :bdg-secondary:`pandas` :bdg-secondary:`matplotlib` :bdg-secondary:`cartopy` :bdg-secondary:`AWS` :bdg-secondary:`intake` :bdg-secondary:`pyleoclim`, :bdg-success:`Lifehacks` :bdg-success:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducing the Hockey Stick - Proxy composite over the past 2,000 years using the cfr package :bdg-danger:`2k Proxy Composite`
                            ...
                            :bdg-primary:`proxy composite` :bdg-primary:`temperature`, :bdg-secondary:`pandas` :bdg-secondary:`numpy` :bdg-secondary:`cfr` :bdg-secondary:`seaborn` :bdg-secondary:`pyleoclim`, :bdg-success:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Watermass Geometry Proto exercise :bdg-danger:`PrototypeWMG`
                            ...
                            :bdg-primary:`tracers` :bdg-primary:`clustering` :bdg-primary:`endmember mixing` :bdg-primary:`watermass geometry`, :bdg-secondary:`sqlalchemy` :bdg-secondary:`pandas` :bdg-secondary:`matplotlib` :bdg-secondary:`scipy` :bdg-secondary:`scikit-learn` :bdg-secondary:`basemap`, :bdg-success:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Detecting paleoclimate transitions with Laplacian Eigenmaps of Recurrence Matrices (LERM) :bdg-danger:`Detecting Paleoclimate Transitions with LERM`
                            ...
                            :bdg-primary:`data viz`, :bdg-secondary:`matplotlib` :bdg-secondary:`ammonyte` :bdg-secondary:`pyleoclim`, :bdg-success:`Main Analysis` :bdg-success:`Extras`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducible workflows using the Pyleoclim package :bdg-danger:`Pyleoclim science`
                            ...
                            :bdg-primary:`correlation` :bdg-primary:`age uncertainty` :bdg-primary:`paleoceanography` :bdg-primary:`model output` :bdg-primary:`wavelet analysis` :bdg-primary:`insolation` :bdg-primary:`model-data comparison` :bdg-primary:`paleoclimate` :bdg-primary:`spectral analysis` :bdg-primary:`cross-wavelet analysis`, :bdg-secondary:`xarray` :bdg-secondary:`climlab` :bdg-secondary:`pylipd` :bdg-secondary:`cartopy` :bdg-secondary:`pyleoclim`, :bdg-success:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Coral Sr/Ca Calibration - An Example from Dry Tortugas :bdg-danger:`Coral Sr/Ca calibration`
                            ...
                            :bdg-primary:`Paleocenography` :bdg-primary:`Bayesian Statistics` :bdg-primary:`calibration` :bdg-primary:`paleoceanography` :bdg-primary:`coral` :bdg-primary:`Calibration` :bdg-primary:`Sr/Ca` :bdg-primary:`Statistics`, :bdg-secondary:`Great Tables` :bdg-secondary:`pandas` :bdg-secondary:`matplotlib` :bdg-secondary:`arviz` :bdg-secondary:`statsmodel` :bdg-secondary:`pymc` :bdg-secondary:`pyleoclim`, :bdg-success:`Calibration` :bdg-success:`Getting Started`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Investigating interhemispheric precipitation changes over the past millennium :bdg-danger:`PaleoPCA`
                            ...
                            :bdg-primary:`modeling` :bdg-primary:`PCA` :bdg-primary:`paleoceanography`, :bdg-secondary:`xarray` :bdg-secondary:`eofs` :bdg-secondary:`pandas` :bdg-secondary:`matplotlib` :bdg-secondary:`cartopy` :bdg-secondary:`pyleoclim`, :bdg-success:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Comparing Paleoclimate Ensembles :bdg-danger:`PaleoEnsembles`
                            ...
                            :bdg-primary:`timeseries modeling` :bdg-primary:`data assimilation` :bdg-primary:`paleoclimatology` :bdg-primary:`PaMoDaCo` :bdg-primary:`data viz` :bdg-primary:`Common Era` :bdg-primary:`reconstruction` :bdg-primary:`PMIP` :bdg-primary:`statistics`, :bdg-secondary:`statsmodels` :bdg-secondary:`pandas` :bdg-secondary:`matplotlib` :bdg-secondary:`scipy` :bdg-secondary:`pens` :bdg-secondary:`seaborn` :bdg-secondary:`pyleoclim`, :bdg-success:`Paleoclimate Applications` :bdg-success:`Plume Distance` :bdg-success:`Temporal Interpretation` :bdg-success:`Motivation`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Regime Shifts in Holocene Paleohydrology as Recorded by Asian Speleothems :bdg-danger:`Asian Speleothem Coherency`
                            ...
                            :bdg-primary:`data analysis` :bdg-primary:`data wrangling` :bdg-primary:`data viz`, :bdg-secondary:`matplotlib` :bdg-secondary:`pylipd` :bdg-secondary:`basemap` :bdg-secondary:`pyLiPD` :bdg-secondary:`ammonyte` :bdg-secondary:`pyleoclim`, :bdg-success:`Exploring the Data` :bdg-success:`Loading Data` :bdg-success:`Main Analysis`
