...
.. raw:: html
    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-scroll" aria-labelledby="formatsDropdown">
        <li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=calibration onchange="change();">&nbsp;Calibration</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=common-era-solar-signature onchange="change();">&nbsp;Common Era Solar Signature</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=core-methods onchange="change();">&nbsp;Core Methods</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=correlation-analysis onchange="change();">&nbsp;Correlation Analysis</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=data-assembly onchange="change();">&nbsp;Data Assembly</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=data-assimilation onchange="change();">&nbsp;Data Assimilation</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=data-manipulation onchange="change();">&nbsp;Data Manipulation</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=deep-diving onchange="change();">&nbsp;Deep Diving</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=ec-calculations onchange="change();">&nbsp;EC Calculations</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=exploring-the-data onchange="change();">&nbsp;Exploring the Data</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=extensions onchange="change();">&nbsp;Extensions</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=extras onchange="change();">&nbsp;Extras</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=getting-started onchange="change();">&nbsp;Getting Started</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=global-coherence-analysis onchange="change();">&nbsp;Global Coherence Analysis</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=heuristic-examples onchange="change();">&nbsp;Heuristic Examples</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=lifehacks onchange="change();">&nbsp;Lifehacks</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=loading-data onchange="change();">&nbsp;Loading Data</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=main-analysis onchange="change();">&nbsp;Main Analysis</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=millennial--to-orbital-scale-variability-and-insolation onchange="change();">&nbsp;Millennial- to orbital-scale variability and Insolation</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=motivation onchange="change();">&nbsp;Motivation</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=paleoclimate-applications onchange="change();">&nbsp;Paleoclimate Applications</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=plume-distance onchange="change();">&nbsp;Plume Distance</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=science-bits onchange="change();">&nbsp;Science Bits</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=supplement onchange="change();">&nbsp;Supplement</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=temporal-interpretation onchange="change();">&nbsp;Temporal Interpretation</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=validation-and-comparison onchange="change();">&nbsp;Validation and Comparison</label></li>
      </ul>
    </div>
...
.. grid:: 1 2 3 3
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: C-iTrace Paleobook :bdg-danger:`C-iTRACE`  :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Science Bits` :bdg-emerald:`Lifehacks`, :bdg-success:`Mystery Interval` :bdg-success:`coordinate systems` :bdg-success:`eNd` :bdg-success:`Deglaciation` :bdg-success:`oceanography` :bdg-success:`C14` :bdg-success:`model output` :bdg-success:`Paleoceanography` :bdg-success:`watermass geometry` :bdg-success:`clustering` :bdg-success:`data viz` :bdg-success:`machine learning` :bdg-success:`tracers`, :bdg-primary:`xarray` :bdg-primary:`pandas` :bdg-primary:`seaborn` :bdg-primary:`cartopy` :bdg-primary:`matplotlib` :bdg-primary:`scikit-learn` :bdg-primary:`intake`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: LMR-CMIP6 Paleobook :bdg-danger:`LMR-CMIP6`  :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Science Bits` :bdg-emerald:`Lifehacks`, :bdg-success:`LMR` :bdg-success:`coordinate systems` :bdg-success:`cloud-ready data` :bdg-success:`Volcanic Input` :bdg-success:`model output` :bdg-success:`AWS` :bdg-success:`Holocene climate` :bdg-success:`CMIP6` :bdg-success:`data viz`, :bdg-primary:`ipywidgets` :bdg-primary:`pyleoclim` :bdg-primary:`AWS` :bdg-primary:`xarray` :bdg-primary:`pandas` :bdg-primary:`cartopy` :bdg-primary:`matplotlib` :bdg-primary:`intake`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: Reproducing the Hockey Stick - Proxy composite over the past 2,000 years using the cfr package :bdg-danger:`2k Proxy Composite`  :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Science Bits`, :bdg-success:`proxy composite` :bdg-success:`temperature`, :bdg-primary:`numpy` :bdg-primary:`seaborn` :bdg-primary:`pyleoclim` :bdg-primary:`pandas` :bdg-primary:`cfr`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: Watermass Geometry Proto exercise :bdg-danger:`PrototypeWMG`  :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Science Bits`, :bdg-success:`watermass geometry` :bdg-success:`endmember mixing` :bdg-success:`clustering` :bdg-success:`tracers`, :bdg-primary:`basemap` :bdg-primary:`scipy` :bdg-primary:`sqlalchemy` :bdg-primary:`pandas` :bdg-primary:`matplotlib` :bdg-primary:`scikit-learn`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            :tags: detecting-paleoclimate-transitions-with-lerm extras main-analysis ammonyte data-viz matplotlib published pyleoclim python
                            :outline: teal

                            .. card:: Detecting paleoclimate transitions with Laplacian Eigenmaps of Recurrence Matrices (LERM) :bdg-danger:`Detecting Paleoclimate Transitions with LERM` :bdg-warning:`published` :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Extras` :bdg-emerald:`Main Analysis`, :bdg-success:`data viz`, :bdg-primary:`pyleoclim` :bdg-primary:`matplotlib` :bdg-primary:`ammonyte`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            :tags: pyleoclim-science science-bits age-uncertainty cartopy climlab correlation cross-wavelet-analysis insolation model-output model-data-comparison paleoceanography paleoclimate published pyleoclim pylipd python spectral-analysis wavelet-analysis xarray
                            :outline: teal

                            .. card:: Reproducible workflows using the Pyleoclim package :bdg-danger:`Pyleoclim science` :bdg-warning:`published` :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Science Bits`, :bdg-success:`model-data comparison` :bdg-success:`spectral analysis` :bdg-success:`model output` :bdg-success:`wavelet analysis` :bdg-success:`paleoclimate` :bdg-success:`insolation` :bdg-success:`paleoceanography` :bdg-success:`age uncertainty` :bdg-success:`correlation` :bdg-success:`cross-wavelet analysis`, :bdg-primary:`pyleoclim` :bdg-primary:`climlab` :bdg-primary:`xarray` :bdg-primary:`cartopy` :bdg-primary:`pylipd`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: Coral Sr/Ca Calibration - An Example from Dry Tortugas :bdg-danger:`Coral Sr/Ca calibration`  :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Calibration` :bdg-emerald:`Getting Started`, :bdg-success:`Bayesian Statistics` :bdg-success:`Sr/Ca` :bdg-success:`calibration` :bdg-success:`Statistics` :bdg-success:`coral` :bdg-success:`Paleocenography` :bdg-success:`Calibration` :bdg-success:`paleoceanography`, :bdg-primary:`statsmodel` :bdg-primary:`pymc` :bdg-primary:`pyleoclim` :bdg-primary:`arviz` :bdg-primary:`pandas` :bdg-primary:`Great Tables` :bdg-primary:`matplotlib`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            :tags: common-era motivation pmip pamodaco paleoensembles paleoclimate-applications plume-distance temporal-interpretation data-assimilation data-viz matplotlib paleoclimatology pandas pens published pyleoclim python reconstruction scipy seaborn statistics statsmodels timeseries-modeling
                            :outline: teal

                            .. card:: Comparing Paleoclimate Ensembles :bdg-danger:`PaleoEnsembles` :bdg-warning:`published` :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Motivation` :bdg-emerald:`Temporal Interpretation` :bdg-emerald:`Plume Distance` :bdg-emerald:`Paleoclimate Applications`, :bdg-success:`data assimilation` :bdg-success:`PaMoDaCo` :bdg-success:`statistics` :bdg-success:`timeseries modeling` :bdg-success:`reconstruction` :bdg-success:`PMIP` :bdg-success:`data viz` :bdg-success:`paleoclimatology` :bdg-success:`Common Era`, :bdg-primary:`statsmodels` :bdg-primary:`pyleoclim` :bdg-primary:`scipy` :bdg-primary:`pandas` :bdg-primary:`pens` :bdg-primary:`seaborn` :bdg-primary:`matplotlib`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            :tags: asian-speleothem-coherency exploring-the-data loading-data main-analysis ammonyte basemap data-analysis data-viz data-wrangling matplotlib published pylipd pyleoclim pylipd python
                            :outline: teal

                            .. card:: Regime Shifts in Holocene Paleohydrology as Recorded by Asian Speleothems :bdg-danger:`Asian Speleothem Coherency` :bdg-warning:`published` :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Loading Data` :bdg-emerald:`Main Analysis` :bdg-emerald:`Exploring the Data`, :bdg-success:`data wrangling` :bdg-success:`data viz` :bdg-success:`data analysis`, :bdg-primary:`pyleoclim` :bdg-primary:`basemap` :bdg-primary:`ammonyte` :bdg-primary:`pyLiPD` :bdg-primary:`matplotlib` :bdg-primary:`pylipd`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: geoChronR Vignettes (McKay et al., 2021) :bdg-danger:`geoChronR` :bdg-warning:`published` :bdg-mauve:`R`
                                ...
                                :bdg-emerald:`Core Methods` :bdg-emerald:`Data Manipulation` :bdg-emerald:`Extensions`, :bdg-success:`wavelets` :bdg-success:`data wrangling` :bdg-success:`regression` :bdg-success:`dimension reduction` :bdg-success:`tidyverse` :bdg-success:`PCA` :bdg-success:`calibration` :bdg-success:`uncertainty quantification` :bdg-success:`LiPD` :bdg-success:`visualization` :bdg-success:`mapping` :bdg-success:`ensemble` :bdg-success:`age uncertainty` :bdg-success:`correlation` :bdg-success:`age modeling` :bdg-success:`spectral analysis`, :bdg-primary:`purrr` :bdg-primary:`readr` :bdg-primary:`dplyr` :bdg-primary:`ggplot2` :bdg-primary:`oxcAAR` :bdg-primary:`lipdR`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            :tags: correlation-analysis exploring-the-data global-coherence-analysis global-speleothem-analysis heuristic-examples cartopy climlab data-analysis data-viz data-wrangling geospatial matplotlib numpy paleoclimate published pyleoclim pylipd python signal-processing statistics
                            :outline: teal

                            .. card:: Global Speleothem Analysis Reveals State-Dependent Hydrological Response to Orbital Forcing :bdg-danger:`Global Speleothem Analysis` :bdg-warning:`published` :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Global Coherence Analysis` :bdg-emerald:`Correlation Analysis` :bdg-emerald:`Heuristic Examples` :bdg-emerald:`Exploring the Data`, :bdg-success:`data wrangling` :bdg-success:`geospatial` :bdg-success:`statistics` :bdg-success:`signal processing` :bdg-success:`paleoclimate` :bdg-success:`data analysis` :bdg-success:`data viz`, :bdg-primary:`numpy` :bdg-primary:`pyleoclim` :bdg-primary:`climlab` :bdg-primary:`cartopy` :bdg-primary:`matplotlib` :bdg-primary:`pylipd`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            :tags: ec-calculations ecs-(cropper-et-al,-2023) main-analysis supplement climate-sensitivity data-supplement data-viz matplotlib published pyleoclim python scipy statsmodels
                            :outline: teal

                            .. card:: Constraining Equilibrium Climate Sensitivity using the Last Millennium GMST :bdg-danger:`ECS (Cropper et al, 2023)` :bdg-warning:`published` :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Supplement` :bdg-emerald:`EC Calculations` :bdg-emerald:`Main Analysis`, :bdg-success:`data supplement` :bdg-success:`data viz` :bdg-success:`climate sensitivity`, :bdg-primary:`pyleoclim` :bdg-primary:`matplotlib` :bdg-primary:`statsmodels` :bdg-primary:`scipy`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: Reproducing LMRv2.1 with PAGES 2k records and LinkedEarth tools :bdg-danger:`Assimilating PAGES2k with CFR`  :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Validation and Comparison` :bdg-emerald:`Data Assembly` :bdg-emerald:`Data Assimilation`, :bdg-success:`data wrangling` :bdg-success:`data viz` :bdg-success:`data assimilation` :bdg-success:`data analysis`, :bdg-primary:`matplotlib` :bdg-primary:`xarray` :bdg-primary:`pens` :bdg-primary:`cfr`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            ...
                            .. card:: Updating LMRv2.1 with PReSto2k data and LinkedEarth Tools :bdg-danger:`Assimilating PReSto2k with CFR`  :bdg-teal:`python`
                                ...
                                :bdg-emerald:`Validation and Comparison` :bdg-emerald:`Data Assembly` :bdg-emerald:`Data Assimilation`, :bdg-success:`data wrangling` :bdg-success:`data viz` :bdg-success:`data assimilation` :bdg-success:`data analysis`, :bdg-primary:`pens` :bdg-primary:`cfr` :bdg-primary:`cartopy` :bdg-primary:`matplotlib` :bdg-primary:`pylipd`
                    ...
                    .. grid-item::
                        ...
                        .. tagged-card:: 
                            :tags: common-era-solar-signature deep-diving fun-in-frequency-domain millennial--to-orbital-scale-variability-and-insolation sparql cartopy cross-wavelet-analysis insolation knowledge-base matplotlib paleoclimate pandas pangaeapy pyleoclim pylipd python scaling-behavior seaborn singular-spectrum-analysis spectral-analysis spectral-peaks wavelet-analysis
                            :outline: teal

                            .. card:: Fun in Frequency Domain :bdg-danger:`Fun in Frequency Domain`  :bdg-teal:`python`
                                :link: https://linked.earth/FreqFun/
                                :img-top: https://raw.githubusercontent.com/LinkedEarth/FreqFun/master/thumbnails/thumbnail.png
                                :img-alt: thumbnail.png

                                :bdg-emerald:`Common Era Solar Signature` :bdg-emerald:`Deep Diving` :bdg-emerald:`Millennial- to orbital-scale variability and Insolation`, :bdg-success:`scaling behavior` :bdg-success:`SPARQL` :bdg-success:`spectral analysis` :bdg-success:`singular spectrum analysis` :bdg-success:`knowledge base` :bdg-success:`wavelet analysis` :bdg-success:`paleoclimate` :bdg-success:`insolation` :bdg-success:`spectral peaks` :bdg-success:`cross-wavelet analysis`, :bdg-primary:`pyleoclim` :bdg-primary:`pangaeapy` :bdg-primary:`pandas` :bdg-primary:`seaborn` :bdg-primary:`cartopy` :bdg-primary:`matplotlib` :bdg-primary:`pylipd`
...
.. grid:: 1 2 3 3
                        ...
                        .. grid-item::
                            ...
                            .. tagged-card:: 
                                :tags: common-era-solar-signature fun-in-frequency-domain cross-wavelet-analysis insolation notebook paleoclimate pyleoclim python
                                :outline: teal

                                .. card:: Solar-Climate Connections :bdg-danger:`Fun in Frequency Domain` :bdg-teal:`python`
                                    :link: https://linked.earth/FreqFun/notebooks/01-solar_climate2k
                                    :img-top: https://raw.githubusercontent.com/LinkedEarth/FreqFun/master/thumbnails/ce_solar.png
                                    :img-alt: ce_solar.png



                                    :bdg-emerald:`cross-wavelet analysis` :bdg-emerald:`insolation` :bdg-emerald:`paleoclimate`, :bdg-success:`pyleoclim`, :bdg-primary:`Common Era Solar Signature`
                        ...
                        .. grid-item::
                            ...
                            .. tagged-card:: 
                                :tags: fun-in-frequency-domain millennial--to-orbital-scale-variability-and-insolation sparql knowledge-base notebook pandas python
                                :outline: teal

                                .. card:: Query LiPDGraph :bdg-danger:`Fun in Frequency Domain` :bdg-teal:`python`
                                    :link: https://linked.earth/FreqFun/notebooks/02a-query_lipd_graph
                                    :img-top: https://raw.githubusercontent.com/LinkedEarth/FreqFun/master/thumbnails/query_res.png
                                    :img-alt: query_res.png



                                    :bdg-emerald:`SPARQL` :bdg-emerald:`knowledge base`, :bdg-success:`pandas`, :bdg-primary:`Millennial- to orbital-scale variability and Insolation`
                        ...
                        .. grid-item::
                            ...
                            .. tagged-card:: 
                                :tags: fun-in-frequency-domain millennial--to-orbital-scale-variability-and-insolation cartopy matplotlib notebook paleoclimate pyleoclim pylipd python scaling-behavior seaborn spectral-analysis
                                :outline: teal

                                .. card:: Scaling Behavior :bdg-danger:`Fun in Frequency Domain` :bdg-teal:`python`
                                    :link: https://linked.earth/FreqFun/notebooks/02b-spectral_analysis_temp12k
                                    :img-top: https://raw.githubusercontent.com/LinkedEarth/FreqFun/master/thumbnails/scaling.png
                                    :img-alt: scaling.png



                                    :bdg-emerald:`paleoclimate` :bdg-emerald:`spectral analysis` :bdg-emerald:`scaling behavior`, :bdg-success:`pyleoclim` :bdg-success:`pylipd` :bdg-success:`seaborn` :bdg-success:`matplotlib` :bdg-success:`cartopy`, :bdg-primary:`Millennial- to orbital-scale variability and Insolation`
                        ...
                        .. grid-item::
                            ...
                            .. tagged-card:: 
                                :tags: fun-in-frequency-domain millennial--to-orbital-scale-variability-and-insolation cartopy matplotlib notebook paleoclimate pyleoclim python seaborn spectral-analysis spectral-peaks
                                :outline: teal

                                .. card:: Spectral Peaks :bdg-danger:`Fun in Frequency Domain` :bdg-teal:`python`
                                    :link: https://linked.earth/FreqFun/notebooks/02c-spectral_analysis_peaks_temp12k
                                    :img-top: https://raw.githubusercontent.com/LinkedEarth/FreqFun/master/thumbnails/peaks.png
                                    :img-alt: peaks.png



                                    :bdg-emerald:`paleoclimate` :bdg-emerald:`spectral analysis` :bdg-emerald:`spectral peaks`, :bdg-success:`pyleoclim` :bdg-success:`seaborn` :bdg-success:`matplotlib` :bdg-success:`cartopy`, :bdg-primary:`Millennial- to orbital-scale variability and Insolation`
                        ...
                        .. grid-item::
                            ...
                            .. tagged-card:: 
                                :tags: deep-diving fun-in-frequency-domain cross-wavelet-analysis notebook paleoclimate pyleoclim python singular-spectrum-analysis spectral-analysis wavelet-analysis
                                :outline: teal

                                .. card:: EPICAC :bdg-danger:`Fun in Frequency Domain` :bdg-teal:`python`
                                    :link: https://linked.earth/FreqFun/notebooks/03-EpicaDomeC_explore
                                    :img-top: https://raw.githubusercontent.com/LinkedEarth/FreqFun/master/thumbnails/epica.png
                                    :img-alt: epica.png



                                    :bdg-emerald:`paleoclimate` :bdg-emerald:`spectral analysis` :bdg-emerald:`wavelet analysis` :bdg-emerald:`cross-wavelet analysis` :bdg-emerald:`singular spectrum analysis`, :bdg-success:`pyleoclim`, :bdg-primary:`Deep Diving`
                        ...
                        .. grid-item::
                            ...
                            .. tagged-card:: 
                                :tags: deep-diving fun-in-frequency-domain cross-wavelet-analysis notebook paleoclimate pangaeapy pyleoclim python spectral-analysis
                                :outline: teal

                                .. card:: U1385 :bdg-danger:`Fun in Frequency Domain` :bdg-teal:`python`
                                    :link: https://linked.earth/FreqFun/04-IODP389-U1385
                                    :img-top: https://raw.githubusercontent.com/LinkedEarth/FreqFun/master/thumbnails/iodp.png
                                    :img-alt: iodp.png



                                    :bdg-emerald:`paleoclimate` :bdg-emerald:`spectral analysis` :bdg-emerald:`cross-wavelet analysis`, :bdg-success:`pyleoclim` :bdg-success:`pangaeapy`, :bdg-primary:`Deep Diving`
