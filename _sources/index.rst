                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: C-iTrace Paleobook :bdg-danger:`C-iTRACE` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`coordinate systems` :bdg-emerald:`watermass geometry` :bdg-emerald:`Deglaciation` :bdg-emerald:`clustering` :bdg-emerald:`model output` :bdg-emerald:`tracers` :bdg-emerald:`machine learning` :bdg-emerald:`Paleoceanography` :bdg-emerald:`C14` :bdg-emerald:`data viz` :bdg-emerald:`eNd` :bdg-emerald:`Mystery Interval` :bdg-emerald:`oceanography`, :bdg-success:`xarray` :bdg-success:`intake` :bdg-success:`cartopy` :bdg-success:`pandas` :bdg-success:`seaborn` :bdg-success:`matplotlib` :bdg-success:`scikit-learn`, :bdg-primary:`Lifehacks` :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: LMR-CMIP6 Paleobook :bdg-danger:`LMR-CMIP6` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`CMIP6` :bdg-emerald:`LMR` :bdg-emerald:`coordinate systems` :bdg-emerald:`model output` :bdg-emerald:`AWS` :bdg-emerald:`Volcanic Input` :bdg-emerald:`data viz` :bdg-emerald:`cloud-ready data` :bdg-emerald:`Holocene climate`, :bdg-success:`xarray` :bdg-success:`intake` :bdg-success:`AWS` :bdg-success:`pyleoclim` :bdg-success:`cartopy` :bdg-success:`pandas` :bdg-success:`matplotlib` :bdg-success:`ipywidgets`, :bdg-primary:`Lifehacks` :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducing the Hockey Stick - Proxy composite over the past 2,000 years using the cfr package :bdg-danger:`2k Proxy Composite` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`proxy composite` :bdg-emerald:`temperature`, :bdg-success:`cfr` :bdg-success:`pyleoclim` :bdg-success:`pandas` :bdg-success:`seaborn` :bdg-success:`numpy`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Watermass Geometry Proto exercise :bdg-danger:`PrototypeWMG` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`watermass geometry` :bdg-emerald:`endmember mixing` :bdg-emerald:`clustering` :bdg-emerald:`tracers`, :bdg-success:`basemap` :bdg-success:`sqlalchemy` :bdg-success:`scipy` :bdg-success:`pandas` :bdg-success:`scikit-learn` :bdg-success:`matplotlib`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Detecting paleoclimate transitions with Laplacian Eigenmaps of Recurrence Matrices (LERM) :bdg-danger:`Detecting Paleoclimate Transitions with LERM` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data viz`, :bdg-success:`matplotlib` :bdg-success:`ammonyte` :bdg-success:`pyleoclim`, :bdg-primary:`Extras` :bdg-primary:`Main Analysis`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducible workflows using the Pyleoclim package :bdg-danger:`Pyleoclim science` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`paleoceanography` :bdg-emerald:`cross-wavelet analysis` :bdg-emerald:`paleoclimate` :bdg-emerald:`correlation` :bdg-emerald:`model output` :bdg-emerald:`wavelet analysis` :bdg-emerald:`model-data comparison` :bdg-emerald:`age uncertainty` :bdg-emerald:`insolation` :bdg-emerald:`spectral analysis`, :bdg-success:`xarray` :bdg-success:`pylipd` :bdg-success:`pyleoclim` :bdg-success:`cartopy` :bdg-success:`climlab`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Coral Sr/Ca Calibration - An Example from Dry Tortugas :bdg-danger:`Coral Sr/Ca calibration` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`paleoceanography` :bdg-emerald:`coral` :bdg-emerald:`calibration` :bdg-emerald:`Statistics` :bdg-emerald:`Paleocenography` :bdg-emerald:`Bayesian Statistics` :bdg-emerald:`Calibration` :bdg-emerald:`Sr/Ca`, :bdg-success:`statsmodel` :bdg-success:`Great Tables` :bdg-success:`pyleoclim` :bdg-success:`pandas` :bdg-success:`matplotlib` :bdg-success:`pymc` :bdg-success:`arviz`, :bdg-primary:`Calibration` :bdg-primary:`Getting Started`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Investigating interhemispheric precipitation changes over the past millennium :bdg-danger:`PaleoPCA` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`paleoceanography` :bdg-emerald:`PCA` :bdg-emerald:`modeling`, :bdg-success:`xarray` :bdg-success:`eofs` :bdg-success:`pyleoclim` :bdg-success:`cartopy` :bdg-success:`pandas` :bdg-success:`matplotlib`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Comparing Paleoclimate Ensembles :bdg-danger:`PaleoEnsembles` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`reconstruction` :bdg-emerald:`Common Era` :bdg-emerald:`timeseries modeling` :bdg-emerald:`paleoclimatology` :bdg-emerald:`data viz` :bdg-emerald:`statistics` :bdg-emerald:`PaMoDaCo` :bdg-emerald:`PMIP` :bdg-emerald:`data assimilation`, :bdg-success:`pyleoclim` :bdg-success:`statsmodels` :bdg-success:`scipy` :bdg-success:`seaborn` :bdg-success:`matplotlib` :bdg-success:`pandas` :bdg-success:`pens`, :bdg-primary:`Plume Distance` :bdg-primary:`Motivation` :bdg-primary:`Temporal Interpretation` :bdg-primary:`Paleoclimate Applications`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Regime Shifts in Holocene Paleohydrology as Recorded by Asian Speleothems :bdg-danger:`Asian Speleothem Coherency` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data analysis` :bdg-emerald:`data wrangling` :bdg-emerald:`data viz`, :bdg-success:`basemap` :bdg-success:`pylipd` :bdg-success:`ammonyte` :bdg-success:`pyLiPD` :bdg-success:`pyleoclim` :bdg-success:`matplotlib`, :bdg-primary:`Loading Data` :bdg-primary:`Exploring the Data` :bdg-primary:`Main Analysis`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: geoChronR Vignettes (McKay et al., 2021) :bdg-danger:`geoChronR` :bdg-mauve:`R`
                            ...
                            :bdg-emerald:`wavelets` :bdg-emerald:`visualization` :bdg-emerald:`PCA` :bdg-emerald:`data wrangling` :bdg-emerald:`correlation` :bdg-emerald:`age modeling` :bdg-emerald:`tidyverse` :bdg-emerald:`age uncertainty` :bdg-emerald:`calibration` :bdg-emerald:`ensemble` :bdg-emerald:`dimension reduction` :bdg-emerald:`mapping` :bdg-emerald:`LiPD` :bdg-emerald:`spectral analysis` :bdg-emerald:`uncertainty quantification` :bdg-emerald:`regression`, :bdg-success:`dplyr` :bdg-success:`ggplot2` :bdg-success:`purrr` :bdg-success:`readr` :bdg-success:`lipdR` :bdg-success:`oxcAAR`, :bdg-primary:`Data Manipulation` :bdg-primary:`Core Methods` :bdg-primary:`Extensions`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Assimilating PAGES 2k records with LinkedEarth tools :bdg-danger:`Assimilating PAGES2k with CFR` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data analysis` :bdg-emerald:`data wrangling` :bdg-emerald:`data viz` :bdg-emerald:`data assimilation`, :bdg-success:`cfr` :bdg-success:`pens` :bdg-success:`matplotlib` :bdg-success:`xarray`, :bdg-primary:`Data Assimilation` :bdg-primary:`Data Assembly` :bdg-primary:`Validation and Comparison`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Global Speleothem Analysis Reveals State-Dependent Hydrological Response to Orbital Forcing :bdg-danger:`Global Speleothem Analysis` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`paleoclimate` :bdg-emerald:`data wrangling` :bdg-emerald:`geospatial` :bdg-emerald:`data analysis` :bdg-emerald:`signal processing` :bdg-emerald:`data viz` :bdg-emerald:`statistics`, :bdg-success:`pylipd` :bdg-success:`pyleoclim` :bdg-success:`cartopy` :bdg-success:`matplotlib` :bdg-success:`climlab` :bdg-success:`numpy`, :bdg-primary:`Global Coherence Analysis` :bdg-primary:`Exploring the Data` :bdg-primary:`Correlation Analysis` :bdg-primary:`Heuristic Examples`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Constraining Equilibrium Climate Sensitivity using the Last Millennium GMST :bdg-danger:`ECS (Cropper et al, 2023)` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`climate sensitivity` :bdg-emerald:`data viz` :bdg-emerald:`data supplement`, :bdg-success:`statsmodels` :bdg-success:`pyleoclim` :bdg-success:`matplotlib` :bdg-success:`scipy`, :bdg-primary:`Supplement` :bdg-primary:`Main Analysis` :bdg-primary:`EC Calculations`
