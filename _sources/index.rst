...
.. raw:: html
    ...
    Formats</button>
    <ul class="dropdown-menu" aria-labelledby="formatsDropdown"><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=2k-proxy-composite onchange="change();">&nbsp;2k Proxy Composite</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=ancientwmg onchange="change();">&nbsp;AncientWMG</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=c-itrace onchange="change();">&nbsp;C-iTRACE</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=lmr-cmip6 onchange="change();">&nbsp;LMR-CMIP6</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=lifehacks onchange="change();">&nbsp;Lifehacks</label></li><li><label class="dropdown-item checkbox formats"><input type="checkbox" rel=science-bits onchange="change();">&nbsp;Science Bits</label></li></ul>
    </div>
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: C-iTrace Paleobook
                            ...
                            :bdg-primary:`model output`, :bdg-primary:`data viz`, :bdg-primary:`Paleoceanography`, :bdg-primary:`clustering`, :bdg-primary:`C14`, :bdg-primary:`tracers`, :bdg-primary:`coordinate systems`, :bdg-primary:`machine learning`, :bdg-primary:`Deglaciation`, :bdg-primary:`oceanography`, :bdg-primary:`watermass geometry`, :bdg-primary:`Mystery Interval`, :bdg-primary:`eNd`, :bdg-secondary:`xarray`, :bdg-secondary:`pandas`, :bdg-secondary:`seaborn`, :bdg-secondary:`scikit-learn`, :bdg-secondary:`intake`, :bdg-secondary:`matplotlib`, :bdg-secondary:`cartopy`, :bdg-info:`Science Bits`, :bdg-info:`C-iTRACE`, :bdg-info:`Lifehacks`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: LMR-CMIP6 Paleobook
                            ...
                            :bdg-primary:`model output`, :bdg-primary:`data viz`, :bdg-primary:`AWS`, :bdg-primary:`cloud-ready data`, :bdg-primary:`coordinate systems`, :bdg-primary:`Holocene climate`, :bdg-primary:`Volcanic Input`, :bdg-primary:`CMIP6`, :bdg-primary:`LMR`, :bdg-secondary:`xarray`, :bdg-secondary:`ipywidgets`, :bdg-secondary:`AWS`, :bdg-secondary:`pandas`, :bdg-secondary:`pyleoclim`, :bdg-secondary:`intake`, :bdg-secondary:`matplotlib`, :bdg-secondary:`cartopy`, :bdg-info:`Science Bits`, :bdg-info:`LMR-CMIP6`, :bdg-info:`Lifehacks`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducing the Hockey Stick - Proxy composite over the past 2,000 years using the cfr package
                            ...
                            :bdg-primary:`proxy composite`, :bdg-primary:`temperature`, :bdg-secondary:`pandas`, :bdg-secondary:`cfr`, :bdg-secondary:`numpy`, :bdg-secondary:`seaborn`, :bdg-secondary:`pyleoclim`, :bdg-info:`Science Bits`, :bdg-info:`2k Proxy Composite`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Watermass Geometry Proto exercise
                            ...
                            :bdg-primary:`clustering`, :bdg-primary:`endmember mixing`, :bdg-primary:`watermass geometry`, :bdg-primary:`tracers`, :bdg-secondary:`scipy`, :bdg-secondary:`sqlalchemy`, :bdg-secondary:`pandas`, :bdg-secondary:`scikit-learn`, :bdg-secondary:`matplotlib`, :bdg-secondary:`basemap`, :bdg-info:`Science Bits`, :bdg-info:`AncientWMG`
