                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: C-iTrace Paleobook :bdg-danger:`C-iTRACE` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`eNd` :bdg-emerald:`machine learning` :bdg-emerald:`C14` :bdg-emerald:`coordinate systems` :bdg-emerald:`oceanography` :bdg-emerald:`watermass geometry` :bdg-emerald:`Paleoceanography` :bdg-emerald:`model output` :bdg-emerald:`Mystery Interval` :bdg-emerald:`Deglaciation` :bdg-emerald:`clustering` :bdg-emerald:`data viz` :bdg-emerald:`tracers`, :bdg-success:`cartopy` :bdg-success:`pandas` :bdg-success:`seaborn` :bdg-success:`xarray` :bdg-success:`scikit-learn` :bdg-success:`matplotlib` :bdg-success:`intake`, :bdg-primary:`Lifehacks` :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: LMR-CMIP6 Paleobook :bdg-danger:`LMR-CMIP6` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`Volcanic Input` :bdg-emerald:`Holocene climate` :bdg-emerald:`coordinate systems` :bdg-emerald:`LMR` :bdg-emerald:`model output` :bdg-emerald:`cloud-ready data` :bdg-emerald:`CMIP6` :bdg-emerald:`AWS` :bdg-emerald:`data viz`, :bdg-success:`cartopy` :bdg-success:`pandas` :bdg-success:`ipywidgets` :bdg-success:`xarray` :bdg-success:`pyleoclim` :bdg-success:`matplotlib` :bdg-success:`intake` :bdg-success:`AWS`, :bdg-primary:`Lifehacks` :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Watermass Geometry Proto exercise :bdg-danger:`PrototypeWMG` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`tracers` :bdg-emerald:`clustering` :bdg-emerald:`watermass geometry` :bdg-emerald:`endmember mixing`, :bdg-success:`scipy` :bdg-success:`pandas` :bdg-success:`sqlalchemy` :bdg-success:`basemap` :bdg-success:`scikit-learn` :bdg-success:`matplotlib`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducible workflows using the Pyleoclim package :bdg-danger:`Pyleoclim science` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`paleoclimate` :bdg-emerald:`spectral analysis` :bdg-emerald:`insolation` :bdg-emerald:`age uncertainty` :bdg-emerald:`wavelet analysis` :bdg-emerald:`cross-wavelet analysis` :bdg-emerald:`model output` :bdg-emerald:`correlation` :bdg-emerald:`paleoceanography` :bdg-emerald:`model-data comparison`, :bdg-success:`pylipd` :bdg-success:`cartopy` :bdg-success:`xarray` :bdg-success:`climlab` :bdg-success:`pyleoclim`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Coral Sr/Ca Calibration - An Example from Dry Tortugas :bdg-danger:`Coral Sr/Ca calibration` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`Paleocenography` :bdg-emerald:`Bayesian Statistics` :bdg-emerald:`Calibration` :bdg-emerald:`Sr/Ca` :bdg-emerald:`calibration` :bdg-emerald:`paleoceanography` :bdg-emerald:`Statistics` :bdg-emerald:`coral`, :bdg-success:`pandas` :bdg-success:`pymc` :bdg-success:`pyleoclim` :bdg-success:`matplotlib` :bdg-success:`statsmodel` :bdg-success:`Great Tables` :bdg-success:`arviz`, :bdg-primary:`Calibration` :bdg-primary:`Getting Started`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Investigating interhemispheric precipitation changes over the past millennium :bdg-danger:`PaleoPCA` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`PCA` :bdg-emerald:`paleoceanography` :bdg-emerald:`modeling`, :bdg-success:`cartopy` :bdg-success:`pandas` :bdg-success:`xarray` :bdg-success:`eofs` :bdg-success:`pyleoclim` :bdg-success:`matplotlib`, :bdg-primary:`Science Bits`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Comparing Paleoclimate Ensembles :bdg-danger:`PaleoEnsembles` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`statistics` :bdg-emerald:`PaMoDaCo` :bdg-emerald:`PMIP` :bdg-emerald:`data assimilation` :bdg-emerald:`reconstruction` :bdg-emerald:`timeseries modeling` :bdg-emerald:`Common Era` :bdg-emerald:`paleoclimatology` :bdg-emerald:`data viz`, :bdg-success:`scipy` :bdg-success:`seaborn` :bdg-success:`pandas` :bdg-success:`statsmodels` :bdg-success:`pens` :bdg-success:`pyleoclim` :bdg-success:`matplotlib`, :bdg-primary:`Motivation` :bdg-primary:`Temporal Interpretation` :bdg-primary:`Paleoclimate Applications` :bdg-primary:`Plume Distance`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Regime Shifts in Holocene Paleohydrology as Recorded by Asian Speleothems :bdg-danger:`Asian Speleothem Coherency` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data analysis` :bdg-emerald:`data viz` :bdg-emerald:`data wrangling`, :bdg-success:`pylipd` :bdg-success:`pyLiPD` :bdg-success:`basemap` :bdg-success:`pyleoclim` :bdg-success:`matplotlib` :bdg-success:`ammonyte`, :bdg-primary:`Main Analysis` :bdg-primary:`Loading Data` :bdg-primary:`Exploring the Data`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: geoChronR Vignettes (McKay et al., 2021) :bdg-danger:`geoChronR` :bdg-mauve:`R`
                            ...
                            :bdg-emerald:`dimension reduction` :bdg-emerald:`spectral analysis` :bdg-emerald:`age modeling` :bdg-emerald:`ensemble` :bdg-emerald:`visualization` :bdg-emerald:`PCA` :bdg-emerald:`uncertainty quantification` :bdg-emerald:`age uncertainty` :bdg-emerald:`mapping` :bdg-emerald:`correlation` :bdg-emerald:`regression` :bdg-emerald:`tidyverse` :bdg-emerald:`LiPD` :bdg-emerald:`calibration` :bdg-emerald:`wavelets` :bdg-emerald:`data wrangling`, :bdg-success:`lipdR` :bdg-success:`dplyr` :bdg-success:`ggplot2` :bdg-success:`oxcAAR` :bdg-success:`purrr` :bdg-success:`readr`, :bdg-primary:`Data Manipulation` :bdg-primary:`Core Methods` :bdg-primary:`Extensions`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Global Speleothem Analysis Reveals State-Dependent Hydrological Response to Orbital Forcing :bdg-danger:`Global Speleothem Analysis` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`statistics` :bdg-emerald:`paleoclimate` :bdg-emerald:`data analysis` :bdg-emerald:`geospatial` :bdg-emerald:`data viz` :bdg-emerald:`data wrangling` :bdg-emerald:`signal processing`, :bdg-success:`pylipd` :bdg-success:`matplotlib` :bdg-success:`cartopy` :bdg-success:`numpy` :bdg-success:`climlab` :bdg-success:`pyleoclim`, :bdg-primary:`Correlation Analysis` :bdg-primary:`Heuristic Examples` :bdg-primary:`Exploring the Data` :bdg-primary:`Global Coherence Analysis`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Constraining Equilibrium Climate Sensitivity using the Last Millennium GMST :bdg-danger:`ECS (Cropper et al, 2023)` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data supplement` :bdg-emerald:`climate sensitivity` :bdg-emerald:`data viz`, :bdg-success:`scipy` :bdg-success:`pyleoclim` :bdg-success:`statsmodels` :bdg-success:`matplotlib`, :bdg-primary:`Main Analysis` :bdg-primary:`EC Calculations` :bdg-primary:`Supplement`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Reproducing LMRv2.1 with PAGES 2k records and LinkedEarth tools :bdg-danger:`Assimilating PAGES2k with CFR` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data assimilation` :bdg-emerald:`data analysis` :bdg-emerald:`data viz` :bdg-emerald:`data wrangling`, :bdg-success:`cfr` :bdg-success:`pens` :bdg-success:`matplotlib` :bdg-success:`xarray`, :bdg-primary:`Validation and Comparison` :bdg-primary:`Data Assembly` :bdg-primary:`Data Assimilation`
                ...
                .. grid-item::
                    ...
                    .. tagged-card:: 
                        ...
                        .. card:: Updating LMRv2.1 with PReSto2k data and LinkedEarth Tools :bdg-danger:`Assimilating PReSto2k with CFR` :bdg-teal:`python`
                            ...
                            :bdg-emerald:`data assimilation` :bdg-emerald:`data analysis` :bdg-emerald:`data viz` :bdg-emerald:`data wrangling`, :bdg-success:`pylipd` :bdg-success:`cartopy` :bdg-success:`pens` :bdg-success:`matplotlib` :bdg-success:`cfr`, :bdg-primary:`Validation and Comparison` :bdg-primary:`Data Assembly` :bdg-primary:`Data Assimilation`
